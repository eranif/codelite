...
static unsigned char xml_res_file_0[] = { 60,  63, 120, 109, 108, 32,  118, 101, 114, 115, 105, 111, 110, 61,  34,
                                          ...
                                          115, 46, 111, 114, 103, 47,  119, 120, 120, 114, 99,  34,  47,  62,  10 };

void wxCrafterWmuZfdInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/"
                     "clSelectSymbolDialogBase_plugin_bitmaps.cpp$C__src_codelite_Plugin_clSelectSymbolDialogBase_"
                     "plugin_bitmaps.xrc"),
                 xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/"
                                   "clSelectSymbolDialogBase_plugin_bitmaps.cpp$C__src_codelite_Plugin_"
                                   "clSelectSymbolDialogBase_plugin_bitmaps.xrc"));
}
