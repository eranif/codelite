...
private:
    ...
    TagEntryPtr lookup_symbol_by_kind(const wxString& name,
    ...
    TagEntryPtr lookup_child_symbol(TagEntryPtr parent,
    ...
    TagEntryPtr
    resolve_expression(CxxExpression& curexp, TagEntryPtr parent, const std::vector<wxString>& visible_scopes);
    ...
    void update_template_table(TagEntryPtr resolved,
    ...
    std::vector<TagEntryPtr> get_children_of_scope(TagEntryPtr parent,
                                                   const std::vector<wxString>& kinds,
     ...
     */
    std::vector<TagEntryPtr> get_parents_of_tag_no_recurse(TagEntryPtr parent,
                                                           TemplateManager::ptr_t template_manager,
                                                           const std::vector<wxString>& visible_scopes);
...
public:
     ...
     */
    void sort_tags(const std::vector<TagEntryPtr>& tags,
     ...
     */
    TagEntryPtr code_complete(const wxString& expression,
                              const std::vector<wxString>& visible_scopes,
     ...
     */
    size_t word_complete(const wxString& filepath,
                         int line,
     ...
     */
    size_t get_completions(TagEntryPtr parent,
     ...
     */
    size_t get_children_of_current_scope(const std::vector<wxString>& kinds,
                                         const wxString& filter,
                                         const std::vector<wxString>& visible_scopes,
     ...
     */
    size_t get_word_completions(const CxxRemainder& remainder,
                                std::vector<TagEntryPtr>& candidates,
                                const std::vector<wxString>& visible_scopes,
                                const wxStringSet_t& visible_files);

    size_t find_definition(const wxString& filepath,
                           int line,
                           const wxString& expr,
                           const wxString& text,
                           const std::vector<wxString>& visible_scopes,
