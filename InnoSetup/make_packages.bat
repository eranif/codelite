...
SET CODELITE_INSTALLER=codelite-2.5.2.%1

:: Installer name for IDE + MinGW
SET CODELITE_INSTALLER_MINGW=codelite-2.5.2.%1-mingw4.4.1

:: Installer name for IDE + MinGW + WX2.8.10
SET CODELITE_INSTALLER_MINGW_WX=codelite-2.5.2.%1-mingw4.4.1-wx2.8.10
