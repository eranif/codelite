...
void EventsDatabase::FillCommonEvents()
{
    ...
    m_events.PushBack(
        "wxEVT_LEFT_UP", ConnectDetails("wxEVT_LEFT_UP", "wxMouseEvent", _("Process a wxEVT_LEFT_UP event.")));
    ...
    m_events.PushBack(
        "wxEVT_MIDDLE_UP", ConnectDetails("wxEVT_MIDDLE_UP", "wxMouseEvent", _("Process a wxEVT_MIDDLE_UP event")));
    ...
    m_events.PushBack(
        "wxEVT_RIGHT_DOWN", ConnectDetails("wxEVT_RIGHT_DOWN", "wxMouseEvent", _("Process a wxEVT_RIGHT_DOWN event")));
    m_events.PushBack(
        "wxEVT_RIGHT_UP", ConnectDetails("wxEVT_RIGHT_UP", "wxMouseEvent", _("Process a wxEVT_RIGHT_UP event")));
    m_events.PushBack("wxEVT_RIGHT_DCLICK",
                      ConnectDetails("wxEVT_RIGHT_DCLICK", "wxMouseEvent", _("Process a wxEVT_RIGHT_DCLICK event")));
    m_events.PushBack(
        "wxEVT_MOTION", ConnectDetails("wxEVT_MOTION", "wxMouseEvent", _("Process a wxEVT_MOTION event")));
    ...
    m_events.PushBack(
        "wxEVT_MOUSEWHEEL", ConnectDetails("wxEVT_MOUSEWHEEL", "wxMouseEvent", _("Process a wxEVT_MOUSEWHEEL event")));
    m_events.PushBack(
    ...
    // Focus
    m_events.PushBack(
        "wxEVT_SET_FOCUS", ConnectDetails("wxEVT_SET_FOCUS", "wxFocusEvent", _("Process a wxEVT_SET_FOCUS event")));
    m_events.PushBack(
        "wxEVT_KILL_FOCUS", ConnectDetails("wxEVT_KILL_FOCUS", "wxFocusEvent", _("Process a wxEVT_KILL_FOCUS event")));
    ...
    m_events.PushBack(
        "wxEVT_MOVE",
        ConnectDetails(
            "wxEVT_MOVE", "wxMoveEvent", _("Process a wxEVT_MOVE event, which is generated when a window is moved.")));
    m_events.PushBack(
        "wxEVT_UPDATE_UI", ConnectDetails("wxEVT_UPDATE_UI", "wxUpdateUIEvent", _("Process a wxEVT_UPDATE_UI event")));
