...
bool clConsoleGnomeConsole::FindProcessByCommand(const wxString& name, wxString& tty, long& pid)
{
...
clConsoleGnomeConsole::clConsoleGnomeConsole()
{
    SetTerminalCommand("kgx --working-directory=%WD% -e '%COMMAND%'");
    SetEmptyTerminalCommand("kgx --working-directory=%WD%");
}

bool clConsoleGnomeConsole::Start() { return StartProcess(PrepareCommand()); }

bool clConsoleGnomeConsole::StartForDebugger()
{
...
wxString clConsoleGnomeConsole::PrepareCommand()
{
