...
// LLM events.
wxDEFINE_EVENT(wxEVT_LLM_REQUEST, clCommandEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESPONSE, clCommandEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESPONSE_ERROR, clCommandEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESPONSE_COMPLETED, clCommandEvent);
wxDEFINE_EVENT(wxEVT_LLM_IS_AVAILABLE, clCommandEvent);
