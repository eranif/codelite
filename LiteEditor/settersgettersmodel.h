...
#ifndef __SettersGettersModel_GUARD__H__
#define __SettersGettersModel_GUARD__H__
 ...
 * To convert between a wxDataViewItem to a SettersGettersModel_Item class, simply use:
 * @code
 * SettersGettersModel_Item* itemData = reinterpret_cast<SettersGettersModel_Item*>( item.GetID() );
 * if ( itemData ) {
 ...
 * @endcode
 */
class SettersGettersModel_Item
{
protected:
    wxVector<wxVariant>        m_data;
    SettersGettersModel_Item*           m_parent;
    wxVector<SettersGettersModel_Item*> m_children;
    bool                       m_isContainer;
    wxClientData*              m_clientData;

public:
    SettersGettersModel_Item()
        : m_parent(NULL)
        , m_isContainer(false)
        , m_clientData(NULL)
    {}
    virtual ~SettersGettersModel_Item() {
        if ( m_clientData ) {
            delete m_clientData;
            m_clientData = NULL;
        }
        ...
        wxVector<SettersGettersModel_Item*> tmpChildren = m_children;
     ...
     * @param child
     */
    void DeleteChild(SettersGettersModel_Item* child) {
        wxVector<SettersGettersModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
     ...
     * @param child
     */
    void RemoveChild(SettersGettersModel_Item* child) {
        wxVector<SettersGettersModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
        if ( iter != m_children.end() ) {
            m_children.erase(iter);
        }
     ...
     */
    void AddChild(SettersGettersModel_Item* child) {
    ...
    // Setters / Getters
    void SetChildren(const wxVector<SettersGettersModel_Item*>& children) {
        this->m_children = children;
    }
    void SetData(const wxVector<wxVariant>& data) {
        this->m_data = data;
    }
    void SetParent(SettersGettersModel_Item* parent) {
        this->m_parent = parent;
    }
    const wxVector<SettersGettersModel_Item*>& GetChildren() const {
        return m_children;
    }
    wxVector<SettersGettersModel_Item*>& GetChildren() {
        return m_children;
    }
    ...
    SettersGettersModel_Item* GetParent() {
        return m_parent;
    }
...
class SettersGettersModel : public wxDataViewModel
{
protected:
    wxVector<SettersGettersModel_Item*> m_data;
    unsigned int m_colCount;

public:
    SettersGettersModel();
    virtual ~SettersGettersModel();
    ...
    void SetData(const wxVector<SettersGettersModel_Item*> data) {
        this->m_data = data;
    }
    unsigned int GetColCount() const {
        return m_colCount;
    }
    const wxVector<SettersGettersModel_Item*>& GetData() const {
        return m_data;
    }
    wxVector<SettersGettersModel_Item*>& GetData() {
        return m_data;
    }
...
#endif // __SettersGettersModel_GUARD__H__
