...
StringTokenizer::StringTokenizer(const wxString& str, const wxString& strDelimiter, bool bAllowEmptyTokens /* false */)
{
...
int StringTokenizer::Count() const { return (int)m_tokensArr.size(); }
