    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_toolbar = new wxAuiToolBar(
        m_panel149, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel149, wxSize(-1, -1)), wxAUI_TB_DEFAULT_STYLE);
    m_toolbar->SetToolBitmapSize(wxSize(16, 16));

    boxSizer151->Add(m_toolbar, 0, wxEXPAND, WXC_FROM_DIP(5));

    m_dataview = new wxDataViewListCtrl(m_panel149,
                                        wxID_ANY,
                                        wxDefaultPosition,
    ...
    m_dataview->AppendIconTextColumn(
        _("Name"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(300), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_dataview->AppendTextColumn(
        _("Type"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-1), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_dataview->AppendTextColumn(
        _("Size"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-1), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
