...
CPPCheckerProtocol::CPPCheckerProtocol()
{
}
...
bool CPPCheckerProtocol::ReadReply(clNamedPipe* conn, CPPCheckerReply& reply)
{
...
bool CPPCheckerProtocol::ReadRequest(clNamedPipe* conn, CPPCheckerRequest& req)
{
	std::auto_ptr<char> sp;
...
bool CPPCheckerProtocol::SendReply(clNamedPipe* conn, CPPCheckerReply& reply)
{
	size_t buff_size(0);
...
bool CPPCheckerProtocol::SendRequest(clNamedPipe* conn, CPPCheckerRequest& req)
{
	size_t size(0);
	size_t written(0);
