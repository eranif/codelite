...
wxDEFINE_EVENT(wxEVT_WORKSPACE_FILES_SCANNED, clWorkspaceEvent);
...
wxDEFINE_EVENT(wxEVT_FINDINFILES_STOP_SEARCH, clFindInFilesEvent);
...
wxDEFINE_EVENT(wxEVT_SESSION_LOADING, clCommandEvent);
wxDEFINE_EVENT(wxEVT_SESSION_LOADED, clCommandEvent);
...
wxDEFINE_EVENT(wxEVT_FORCE_RESTART_CODELITE, clCommandEvent);
...
// LLM events.
wxDEFINE_EVENT(wxEVT_LLM_REQUEST, clLLMEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESPONSE, clLLMEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESPONSE_ERROR, clLLMEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESPONSE_COMPLETED, clLLMEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESPONSE_ABORTED, clLLMEvent);
wxDEFINE_EVENT(wxEVT_LLM_IS_AVAILABLE, clLLMEvent);
wxDEFINE_EVENT(wxEVT_LLM_UNREGISTER_FUNC, clLLMEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESTART, clLLMEvent);
wxDEFINE_EVENT(wxEVT_LLM_RESTARTED, clLLMEvent);
