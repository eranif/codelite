...
PluginWizardBase::PluginWizardBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxBitmap& bmp, const wxPoint& pos, long style)
{
    ...
    m_wizardPage4 = new wxWizardPageSimple(this, NULL, NULL, wxNullBitmap);
    m_pages.push_back(m_wizardPage4);
    
    wxBoxSizer* boxSizer10 = new wxBoxSizer(wxVERTICAL);
    m_wizardPage4->SetSizer(boxSizer10);
    ...
    m_staticText14 = new wxStaticText(m_wizardPage4, wxID_ANY, _("Plugin name:"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer12->Add(m_staticText14, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textCtrlName = new wxTextCtrl(m_wizardPage4, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1,-1), 0);
    ...
    m_staticText18 = new wxStaticText(m_wizardPage4, wxID_ANY, _("Description:"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer12->Add(m_staticText18, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    
    m_textCtrlDescription = new wxTextCtrl(m_wizardPage4, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1,-1), 0);
    ...
    m_wizardPage8 = new wxWizardPageSimple(this, NULL, NULL, wxNullBitmap);
    m_pages.push_back(m_wizardPage8);
    if (m_pages.size() > 1) {
    ...
    m_wizardPage8->SetSizer(boxSizer22);
    ...
    m_staticText42 = new wxStaticText(m_wizardPage8, wxID_ANY, _("codelite root dir:"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer24->Add(m_staticText42, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    
    m_dirPickerCodeliteDir = new wxDirPickerCtrl(m_wizardPage8, wxID_ANY, wxEmptyString, wxT("Select a folder"), wxDefaultPosition, wxSize(-1,-1), wxDIRP_DEFAULT_STYLE|wxDIRP_DIR_MUST_EXIST);
    ...
    m_staticText26 = new wxStaticText(m_wizardPage8, wxID_ANY, _("Project path:"), wxDefaultPosition, wxSize(-1,-1), 0);
    
    flexGridSizer24->Add(m_staticText26, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    
    m_dirPickerPluginPath = new wxDirPickerCtrl(m_wizardPage8, wxID_ANY, wxEmptyString, wxT("Select a folder"), wxDefaultPosition, wxSize(250,-1), wxDIRP_DEFAULT_STYLE|wxDIRP_DIR_MUST_EXIST);
    ...
    m_textCtrl38 = new wxTextCtrl(m_wizardPage8, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1,-1), 0);
    m_textCtrl38->Enable(false);
    
    flexGridSizer24->Add(m_textCtrl38, 0, wxALL|wxEXPAND, 5);
