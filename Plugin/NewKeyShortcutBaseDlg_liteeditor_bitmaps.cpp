...
void wxC8418InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/"
                     "NewKeyShortcutBaseDlg_liteeditor_bitmaps.cpp$C__src_codelite_Plugin_NewKeyShortcutBaseDlg_"
                     "liteeditor_bitmaps.xrc"),
                 xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/"
                                   "NewKeyShortcutBaseDlg_liteeditor_bitmaps.cpp$C__src_codelite_Plugin_"
                                   "NewKeyShortcutBaseDlg_liteeditor_bitmaps.xrc"));
}
