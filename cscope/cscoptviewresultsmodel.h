...
public:
    ...
    // Setters / Getters
    void SetChildren(const wxVector<CScoptViewResultsModel_Item*>& children) { this->m_children = children; }
    void SetData(const wxVector<wxVariant>& data) { this->m_data = data; }
    void SetParent(CScoptViewResultsModel_Item* parent) { this->m_parent = parent; }
    const wxVector<CScoptViewResultsModel_Item*>& GetChildren() const { return m_children; }
    wxVector<CScoptViewResultsModel_Item*>& GetChildren() { return m_children; }
    const wxVector<wxVariant>& GetData() const { return m_data; }
    wxVector<wxVariant>& GetData() { return m_data; }
    CScoptViewResultsModel_Item* GetParent() { return m_parent; }
...
public:
    ...
    void SetData(const wxVector<CScoptViewResultsModel_Item*> data) { this->m_data = data; }
    unsigned int GetColCount() const { return m_colCount; }
    const wxVector<CScoptViewResultsModel_Item*>& GetData() const { return m_data; }
    wxVector<CScoptViewResultsModel_Item*>& GetData() { return m_data; }
...
public:
    ...
    AppendItem(const wxDataViewItem& parent, const wxVector<wxVariant>& data, wxClientData* clientData = NULL);
     ...
     */
    virtual wxDataViewItem
    InsertItem(const wxDataViewItem& insertBeforeMe, const wxVector<wxVariant>& data, wxClientData* clientData = NULL);
