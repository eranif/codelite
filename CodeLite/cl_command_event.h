...
public:
    ...
    void SetOutputReason(std::optional<assistant::Reason> output_reason) { m_output_reason = output_reason; }
    std::optional<assistant::Reason> GetOutputReason() const { return m_output_reason; }
