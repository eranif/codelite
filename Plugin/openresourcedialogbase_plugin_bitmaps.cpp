...
void wxCFB13InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/"
                     "openresourcedialogbase_plugin_bitmaps.cpp$_home_eran_devl_codelite_Plugin_openresourcedialogbase_"
                     "plugin_bitmaps.xrc"),
                 xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/"
                                   "openresourcedialogbase_plugin_bitmaps.cpp$_home_eran_devl_codelite_Plugin_"
                                   "openresourcedialogbase_plugin_bitmaps.xrc"));
}
