...
public:
    ...
    bool IsClangC11() const
    {
        return m_clangC11;
    }
    void SetClangC14(bool clangC14)
    {
        this->m_clangC14 = clangC14;
    }
    bool IsClangC14() const
    {
        return m_clangC14;
    }
    void SetClangC17(bool clangC17)
    {
        this->m_clangC17 = clangC17;
    }
    bool IsClangC17() const
    {
        return m_clangC17;
    }
    void SetClangCcPCH(const wxString& ccPCH)
    {
        this->m_ccPCH = ccPCH;
    }
    const wxString& GetClangCcPCH() const
    {
        return m_ccPCH;
    }
    ...
    void SetClangCmpFlagsC(const wxString& clangCmpFlagsC)
    {
        this->m_clangCmpFlagsC = clangCmpFlagsC;
    }
    const wxString& GetClangCmpFlagsC() const
    {
        return m_clangCmpFlagsC;
    }
    ...
    void SetBuildSystem(const wxString& buildSystem)
    {
        this->m_buildSystem = buildSystem;
    }
    const wxString& GetBuildSystem() const
    {
    ...
    const wxString& GetBuildSystemArguments() const
    {
        return m_buildSystemArguments;
    }
