...
wxDEFINE_EVENT(wxEVT_TREE_ITEM_FILE_ACTIVATED, wxCommandEvent);
...
wxDEFINE_EVENT(wxEVT_FILE_RENAMED, wxCommandEvent);
...
wxDEFINE_EVENT(wxEVT_CMD_STOP_EXECUTED_PROGRAM, wxCommandEvent);
wxDEFINE_EVENT(wxEVT_CMD_IS_PROGRAM_RUNNING, wxCommandEvent);
...
wxDEFINE_EVENT(wxEVT_DEBUG_STARTING, wxCommandEvent);
wxDEFINE_EVENT(wxEVT_DEBUG_STARTED, wxCommandEvent);
wxDEFINE_EVENT(wxEVT_DEBUG_ENDING, wxCommandEvent);
wxDEFINE_EVENT(wxEVT_DEBUG_ENDED, wxCommandEvent);
...
wxDEFINE_EVENT(wxEVT_CC_CODE_COMPLETE_TAG_COMMENT, clCodeCompletionEvent);
...
wxDEFINE_EVENT(wxEVT_CMD_CREATE_NEW_WORKSPACE, wxCommandEvent);
...
wxDEFINE_EVENT(wxEVT_CMD_EDITOR_MARGIN_CONTEXT_MENU, wxCommandEvent);
wxDEFINE_EVENT(wxEVT_CMD_GET_FIND_IN_FILES_MASK, clCommandEvent);
wxDEFINE_EVENT(wxEVT_CMD_FIND_IN_FILES_DISMISSED, clCommandEvent);
wxDEFINE_EVENT(wxEVT_CMD_EDITOR_TIP_DWELL_END, wxCommandEvent);
...
wxDEFINE_EVENT(wxEVT_FINDBAR_ABOUT_TO_SHOW, wxCommandEvent);
wxDEFINE_EVENT(wxEVT_FINDBAR_RELEASE_EDITOR, wxCommandEvent);
...
wxDEFINE_EVENT(wxEVT_CONTEXT_MENU_EDITOR_SHOWING, clContextMenuEvent);
wxDEFINE_EVENT(wxEVT_CONTEXT_MENU_EDITOR_DISMISSED, clContextMenuEvent);
...
wxDEFINE_EVENT(wxEVT_COLOURS_AND_FONTS_LOADED, clColourEvent);
