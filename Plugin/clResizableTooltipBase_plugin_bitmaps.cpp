...
void wxC126AInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/"
                     "clResizableTooltipBase_plugin_bitmaps.cpp$_mnt_everythingelse_devel_git_CODELITE_Plugin_"
                     "clResizableTooltipBase_plugin_bitmaps.xrc"),
                 xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/"
                                   "clResizableTooltipBase_plugin_bitmaps.cpp$_mnt_everythingelse_devel_git_CODELITE_"
                                   "Plugin_clResizableTooltipBase_plugin_bitmaps.xrc"));
}
