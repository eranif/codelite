...
{
    RegisterEvent("wxEVT_COMMAND_WEBVIEW_NAVIGATING",
                  "wxWebViewEvent",
    ...
    RegisterEvent("wxEVT_COMMAND_WEBVIEW_NAVIGATED",
                  "wxWebViewEvent",
    ...
    RegisterEvent("wxEVT_COMMAND_WEBVIEW_LOADED",
                  "wxWebViewEvent",
                  _("Process a wxEVT_COMMAND_WEBVIEW_LOADED event generated when the document is fully loaded and "
                    ...
                    "generated per frame."));
    RegisterEvent("wxEVT_COMMAND_WEBVIEW_ERROR",
                  "wxWebViewEvent",
    ...
    RegisterEvent("wxEVT_COMMAND_WEBVIEW_NEWWINDOW",
                  "wxWebViewEvent",
                  _("Process a wxEVT_COMMAND_WEBVIEW_NEWWINDOW event, generated when a new window is created. You must "
                    ...
                    "tab."));
    RegisterEvent("wxEVT_COMMAND_WEBVIEW_TITLE_CHANGED",
                  "wxWebViewEvent",
