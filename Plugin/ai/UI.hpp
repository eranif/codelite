...
class ToolTrustLevelDlgBase : public wxDialog
{
protected:
    wxStaticText* m_staticTextMessage;
    wxDataViewListCtrl* m_dvListCtrlOptions;
    wxCheckBox* m_checkBox;
    wxStdDialogButtonSizer* m_stdBtnSizer214;
...
public:
    ...
    ToolTrustLevelDlgBase(wxWindow* parent,
                          wxWindowID id = wxID_ANY,
