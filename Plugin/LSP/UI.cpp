    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_textCtrlFilter = new clThemedTextCtrl(
        m_panel155, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel155, wxSize(-1, -1)), wxTE_PROCESS_ENTER);
#if wxVERSION_NUMBER >= 3000
    ...
    m_dvTreeCtrll = new clTerminalViewCtrl(m_panel155,
                                           wxID_ANY,
                                           wxDefaultPosition,
                                           wxDLG_UNIT(m_panel155, wxSize(-1, -1)),
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    boxSizer194->Add(m_notebook207, 1, wxEXPAND, WXC_FROM_DIP(5));
    ...
    m_stcLog = new wxStyledTextCtrl(m_panel208, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel208, wxSize(-1, -1)), 0);
    // Configure the fold margin
    ...
    boxSizer210->Add(m_stcLog, 1, wxEXPAND, WXC_FROM_DIP(5));
