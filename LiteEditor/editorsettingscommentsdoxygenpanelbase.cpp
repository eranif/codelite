...
EditorSettingsCommentsDoxygenPanelBase::EditorSettingsCommentsDoxygenPanelBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_checkBoxUseSlash2Stars = new wxCheckBox( this, wxID_ANY, _("Use '/**' as doxygen block start (else use '/*!')"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText4 = new wxStaticText( this, wxID_ANY, _("Class prefix:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText5 = new wxStaticText( this, wxID_ANY, _("Function prefix:"), wxDefaultPosition, wxDefaultSize, 0 );
