    ...
    : wxcWidget(ID_WXPROPERTYGRIDMANAGER)
{
    ...
    RegisterEvent("wxEVT_PG_LABEL_EDIT_ENDING",
                  "wxPropertyGridEvent",
    ...
    RegisterEvent("wxEVT_PG_COL_DRAGGING",
                  "wxPropertyGridEvent",
    ...
    RegisterEvent("wxEVT_PG_COL_END_DRAG",
                  "wxPropertyGridEvent",
