...
protected:
     ...
     */
    wxRect DoDraw(wxWindow* parent, wxDC& dc, wxDC& fontDC, const clTabInfo& tabInfo, const clTabColours& colors,
                  size_t style, eButtonState tabState, eButtonState xButtonState);
...
public:
    ...
    void Draw(wxWindow* parent, wxDC& dc, wxDC& fontDC, const clTabInfo& tabInfo, const clTabColours& colours,
              size_t style, eButtonState tabState, eButtonState xButtonState) override;
