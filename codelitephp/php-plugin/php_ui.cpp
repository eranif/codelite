...
BrowserPanelBase::BrowserPanelBase(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style)
    : wxPanel(parent, id, pos, size, style)
{
    ...
    boxSizer71->Add(m_infobar, 0, wxALL|wxEXPAND, 2);
    
    m_banner = new wxBannerWindow(this, wxID_ANY, wxTOP, wxDefaultPosition, wxSize(-1,-1), wxBORDER_THEME);
    m_banner->SetBitmap(wxNullBitmap);
    m_banner->SetText(wxT(""), wxT(""));
    m_banner->SetGradient(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNFACE), wxSystemSettings::GetColour(wxSYS_COLOUR_BTNFACE));
    m_banner->SetForegroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNTEXT));
    
    boxSizer71->Add(m_banner, 0, wxALL|wxEXPAND, 2);
    
    wxBoxSizer* boxSizer81 = new wxBoxSizer(wxHORIZONTAL);
    
    boxSizer71->Add(boxSizer81, 0, wxEXPAND, 5);
    
    m_textCtrlAddressBar = new wxTextCtrl(this, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(-1,-1), wxTE_PROCESS_ENTER);
    #if wxVERSION_NUMBER >= 3000
    m_textCtrlAddressBar->SetHint(wxT(""));
    #endif
    
    boxSizer81->Add(m_textCtrlAddressBar, 1, wxALL|wxALIGN_CENTER_VERTICAL, 2);
    ...
    boxSizer81->Add(m_auibar, 0, wxEXPAND, 5);
    
    m_auibar->AddTool(wxID_OK, _("Go!"), wxXmlResource::Get()->LoadBitmap(wxT("go")), wxNullBitmap, wxITEM_NORMAL, _("Go!"), _("Go!"), NULL);
    m_auibar->Realize();
    
    #if wxUSE_WEBVIEW
    m_webView = wxWebView::New(this, wxID_ANY, _("about:blank"), wxDefaultPosition, wxSize(-1,-1), wxWebViewBackendDefault, wxBORDER_THEME);
    
    boxSizer71->Add(m_webView, 1, wxALL|wxEXPAND, 2);
    #endif // wxUSE_WEBVIEW
    ...
    Centre(wxBOTH);
    // Connect events
    m_textCtrlAddressBar->Connect(wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(BrowserPanelBase::OnGoURL), NULL, this);
    this->Connect(wxID_OK, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler(BrowserPanelBase::OnGoURL), NULL, this);
    this->Connect(wxID_OK, wxEVT_UPDATE_UI, wxUpdateUIEventHandler(BrowserPanelBase::OnGoUI), NULL, this);
    #if wxUSE_WEBVIEW
    m_webView->Connect(wxEVT_COMMAND_WEBVIEW_TITLE_CHANGED, wxWebViewEventHandler(BrowserPanelBase::OnTitleChanged), NULL, this);
    m_webView->Connect(wxEVT_COMMAND_WEBVIEW_NEWWINDOW, wxWebViewEventHandler(BrowserPanelBase::OnNewWindow), NULL, this);
    #endif // wxUSE_WEBVIEW
    
}

BrowserPanelBase::~BrowserPanelBase()
{
    m_textCtrlAddressBar->Disconnect(wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(BrowserPanelBase::OnGoURL), NULL, this);
    this->Disconnect(wxID_OK, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler(BrowserPanelBase::OnGoURL), NULL, this);
    this->Disconnect(wxID_OK, wxEVT_UPDATE_UI, wxUpdateUIEventHandler(BrowserPanelBase::OnGoUI), NULL, this);
    #if wxUSE_WEBVIEW
    m_webView->Disconnect(wxEVT_COMMAND_WEBVIEW_TITLE_CHANGED, wxWebViewEventHandler(BrowserPanelBase::OnTitleChanged), NULL, this);
    m_webView->Disconnect(wxEVT_COMMAND_WEBVIEW_NEWWINDOW, wxWebViewEventHandler(BrowserPanelBase::OnNewWindow), NULL, this);
    #endif // wxUSE_WEBVIEW
