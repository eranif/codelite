    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_checkBoxDontAnnoy = new wxCheckBox(this, wxID_ANY, _("Dont show this message again"), wxDefaultPosition,
                                         wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_button426->SetBitmap(wxXmlResource::Get()->LoadBitmap(wxT("reload")), wxRIGHT);
    m_button426->SetBitmapMargins(2, 2);
#endif
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    wxStaticBoxSizer* staticBoxSizer221 =
        new wxStaticBoxSizer(new wxStaticBox(m_panel174, wxID_ANY, _("Serial Number:")), wxVERTICAL);
    ...
    m_staticText188 = new wxStaticText(m_panel174, wxID_ANY, _("User:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_panel174, wxSize(-1, -1)), 0);
    ...
    m_textCtrl1Username =
        new wxTextCtrl(m_panel174, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel174, wxSize(-1, -1)), 0);
#if wxVERSION_NUMBER >= 3000
    ...
    m_staticTextSerialNumber = new wxStaticText(m_panel174, wxID_ANY, _("Serial:"), wxDefaultPosition,
                                                wxDLG_UNIT(m_panel174, wxSize(-1, -1)), 0);
    ...
    flexGridSizer187->Add(m_staticTextSerialNumber, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL,
                          WXC_FROM_DIP(5));

    m_textCtrlSerialNumber =
        new wxTextCtrl(m_panel174, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel174, wxSize(-1, -1)), 0);
#if wxVERSION_NUMBER >= 3000
    ...
    m_staticText205 = new wxStaticText(m_panel174, wxID_ANY, _("License Status:"), wxDefaultPosition,
                                       wxDLG_UNIT(m_panel174, wxSize(-1, -1)), 0);
    ...
    m_staticBitmapLicenseStatusOK =
        new wxStaticBitmap(m_panel174, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("license-ok")), wxDefaultPosition,
                           wxDLG_UNIT(m_panel174, wxSize(-1, -1)), 0);

    boxSizer207->Add(m_staticBitmapLicenseStatusOK, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_staticBitmapLicenseStatusError =
        new wxStaticBitmap(m_panel174, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("license-error")),
                           wxDefaultPosition, wxDLG_UNIT(m_panel174, wxSize(-1, -1)), 0);
    ...
    m_button195 = new wxButton(m_panel174, wxID_SAVE, _("Activate the Serial Number"), wxDefaultPosition,
                               wxDLG_UNIT(m_panel174, wxSize(-1, -1)), 0);
    ...
    m_banner193 = new wxBannerWindow(m_panel174, wxID_ANY, wxTOP, wxDefaultPosition,
                                     wxDLG_UNIT(m_panel174, wxSize(-1, -1)), wxBORDER_THEME);
    m_banner193->SetBitmap(wxNullBitmap);
    m_banner193->SetText(wxT(""), wxT(""));
    m_banner193->SetGradient(wxSystemSettings::GetColour(wxSYS_COLOUR_INACTIVECAPTION),
                             wxSystemSettings::GetColour(wxSYS_COLOUR_INACTIVECAPTION));

    staticBoxSizer221->Add(m_banner193, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_panel217 = new wxPanel(m_notebook173, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebook173, wxSize(-1, -1)),
                             wxTAB_TRAVERSAL);
    ...
    m_textCtrlEULA =
        new wxTextCtrl(m_panel217, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel217, wxSize(-1, -1)),
                       wxTE_RICH2 | wxTE_READONLY | wxTE_MULTILINE);
    ...
    m_textCtrl1Username->Connect(wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler(wxcAboutDlgBaseClass::OnTextUpdated),
                                 NULL, this);
    m_textCtrlSerialNumber->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                                    wxCommandEventHandler(wxcAboutDlgBaseClass::OnTextUpdated), NULL, this);
    m_button195->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(wxcAboutDlgBaseClass::OnUpdateLicense),
                         NULL, this);
...
wxcAboutDlgBaseClass::~wxcAboutDlgBaseClass()
{
    ...
    m_textCtrl1Username->Disconnect(wxEVT_COMMAND_TEXT_UPDATED,
                                    wxCommandEventHandler(wxcAboutDlgBaseClass::OnTextUpdated), NULL, this);
    m_textCtrlSerialNumber->Disconnect(wxEVT_COMMAND_TEXT_UPDATED,
                                       wxCommandEventHandler(wxcAboutDlgBaseClass::OnTextUpdated), NULL, this);
    m_button195->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(wxcAboutDlgBaseClass::OnUpdateLicense),
                            NULL, this);
    m_button195->Disconnect(wxEVT_UPDATE_UI, wxUpdateUIEventHandler(wxcAboutDlgBaseClass::OnUpdateLicenseUI), NULL,
                            this);
}
