...
public:
    ...
    void SetExtends(const wxArrayString& extends) { this->m_extends = extends; }
    void SetImplements(const wxArrayString& implements) { this->m_implements = implements; }
    const wxArrayString& GetExtends() const { return m_extends; }
    const wxArrayString& GetImplements() const { return m_implements; }
    const wxString& GetType() const { return m_type; }
    void SetClassNamespace(const wxString& classNamespace) { this->m_classNamespace = classNamespace; }
    const wxString& GetNamespace() const { return m_classNamespace; }
    void SetName(const wxString& name) { this->m_name = name; }
    const wxString& GetName() const { return m_name; }
    void SetFilepath(const wxFileName& filepath) { this->m_filepath = filepath; }
    const wxFileName& GetFilepath() const { return m_filepath; }
    void SetFlags(size_t flags) { this->m_flags = flags; }
    size_t GetFlags() const { return m_flags; }

    bool IsClass() const { return GetType() == "class"; }
};
