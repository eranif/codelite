...
void wxC9948InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/DebuggerSettings_liteeditor_bitmaps.cpp$._DebuggerSettings_liteeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/DebuggerSettings_liteeditor_bitmaps.cpp$._DebuggerSettings_liteeditor_bitmaps.xrc"));
}
