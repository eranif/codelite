 ...
 * @link https://developer.mozilla.org/en-US/docs/Web/API/MozMmsEvent
 */
function MozMmsEvent() {
	 ...
	 * @link https://developer.mozilla.org/en-US/docs/Web/API/Event/preventBubble
	 */
	this.preventBubble = function() {};

	/**
	 * @brief The documentation about this has not yet been written; please consider contributing!
	 * @link https://developer.mozilla.org/en-US/docs/Web/API/Event/preventCapture
	 */
	...
	/**
	 * @brief The documentation about this has not yet been written; please consider contributing!
	 * @link https://developer.mozilla.org/en-US/docs/Web/API/Event/getPreventDefault
	 */
	this.getPreventDefault = function() {};
