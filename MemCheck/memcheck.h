...
public:
    ...
    /**
     * @brief true if test is not runnging and GUI can respond, otherwise if test is runnign user can't listing errors and managing supp file
     * @param event
...
protected:
    ...
    AsyncExeCmd * m_checkProcess; ///< Test is run as external tool.
    ...
    /**
     * @brief After CL finish test execution
     * @param event
     */
    void OnCheckProcessEnd(wxProcessEvent &event);
