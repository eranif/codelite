...
void wxCE8CInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/sftp_ui_sftp_bitmaps.cpp$_Users_eifrah_devl_codelite_Plugin_sftp_ui_sftp_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
