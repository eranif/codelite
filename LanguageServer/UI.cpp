    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    // Connect events
    m_buttonScan->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LanguageServerSettingsDlgBase::OnScan), NULL, this);
...
{
    m_buttonScan->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(LanguageServerSettingsDlgBase::OnScan), NULL, this);
