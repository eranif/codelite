...
")
        ...
        execute_process(COMMAND sh -f ${temp_script} WORKING_DIRECTORY ${BUILD_DIR} COMMAND_ERROR_IS_FATAL ANY)
        execute_process(COMMAND make -j10 install WORKING_DIRECTORY "${BUILD_DIR}" COMMAND_ERROR_IS_FATAL ANY)
    endfunction()
    ...
    set(CMAKE_PREFIX_PATH "${CMAKE_PREFIX_PATH};${CMAKE_BINARY_DIR}/local_builds/")
