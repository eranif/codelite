    ...
    , m_indentGuides(StdToWX::ToArrayString({"None", "Real", "Look Forward", "Look Both"}))
{
    ...
    RegisterEvent("wxEVT_STC_SAVEPOINTREACHED",
                  "wxStyledTextEvent",
    ...
    RegisterEvent("wxEVT_STC_SAVEPOINTLEFT",
                  "wxStyledTextEvent",
    ...
    RegisterEvent(
        "wxEVT_STC_ROMODIFYATTEMPT", "wxStyledTextEvent", _("An attempt to modify a read-only document was made"));
    ...
    RegisterEvent("wxEVT_STC_PAINTED",
                  "wxStyledTextEvent",
    ...
    RegisterEvent(
        "wxEVT_STC_USERLISTSELECTION", "wxStyledTextEvent", _("The user has selected an item in a user list."));
    RegisterEvent("wxEVT_STC_URIDROPPED",
                  "wxStyledTextEvent",
    ...
    RegisterEvent("wxEVT_STC_DWELLEND",
                  "wxStyledTextEvent",
    ...
    RegisterEvent(
        "wxEVT_STC_INDICATOR_CLICK", "wxStyledTextEvent", _("User clicked the mouse on a text that has an indicator"));
    RegisterEvent("wxEVT_STC_INDICATOR_RELEASE",
                  "wxStyledTextEvent",
    ...
    RegisterEvent("wxEVT_STC_AUTOCOMP_CHAR_DELETED",
                  "wxStyledTextEvent",
...
wxString StyledTextCtrlWrapper::CppCtorCode() const
{
    ...
    if (wrapMode != -1) {
        cppCode << GetName() << "->SetWrapMode(" << wrapMode << ");\n";
    }
