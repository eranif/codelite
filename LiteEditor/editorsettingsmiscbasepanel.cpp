    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_useSingleToolbar = new wxCheckBox(m_panel1, wxID_ANY, _("Use single toolbar"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_fullFilePath = new wxCheckBox(m_panel1, wxID_ANY, _("Show file's full path in frame title"), wxDefaultPosition, wxSize(-1, -1), 0);
    m_fullFilePath->SetValue(true);
    m_fullFilePath->SetToolTip(_("Display the full path of the selected editor in codelite's frame title. Otherwise, show the file name only"));
    
    staticBoxSizer4->Add(m_fullFilePath, 0, wxALL, 5);
