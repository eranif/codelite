...
#ifndef __FunctionsModel_GUARD__H__
#define __FunctionsModel_GUARD__H__
 ...
 * To convert between a wxDataViewItem to a FunctionsModel_Item class, simply use:
 * @code
 * FunctionsModel_Item* itemData = reinterpret_cast<FunctionsModel_Item*>( item.GetID() );
 * if ( itemData ) {
 ...
 * @endcode
 */
class FunctionsModel_Item
{
protected:
    wxVector<wxVariant>        m_data;
    FunctionsModel_Item*           m_parent;
    wxVector<FunctionsModel_Item*> m_children;
    bool                       m_isContainer;
...
public:
    ...
    virtual ~FunctionsModel_Item() {
        ...
        wxVector<FunctionsModel_Item*> tmpChildren = m_children;
     ...
     * @param child
     */
    void DeleteChild(FunctionsModel_Item* child) {
        wxVector<FunctionsModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
     ...
     * @param child
     */
    void RemoveChild(FunctionsModel_Item* child) {
        wxVector<FunctionsModel_Item*>::iterator iter = std::find(m_children.begin(), m_children.end(), child);
        if ( iter != m_children.end() ) {
            m_children.erase(iter);
        }
     ...
     */
    void AddChild(FunctionsModel_Item* child) {
    ...
    // Setters / Getters
    void SetChildren(const wxVector<FunctionsModel_Item*>& children) {
        this->m_children = children;
    }
    void SetData(const wxVector<wxVariant>& data) {
        this->m_data = data;
    }
    void SetParent(FunctionsModel_Item* parent) {
        this->m_parent = parent;
    }
    const wxVector<FunctionsModel_Item*>& GetChildren() const {
        return m_children;
    }
    wxVector<FunctionsModel_Item*>& GetChildren() {
        return m_children;
    }
...
class FunctionsModel : public wxDataViewModel
{
protected:
    wxVector<FunctionsModel_Item*> m_data;
...
public:
    ...
    void SetData(const wxVector<FunctionsModel_Item*> data) {
        this->m_data = data;
    }
    unsigned int GetColCount() const {
        return m_colCount;
    }
    const wxVector<FunctionsModel_Item*>& GetData() const {
        return m_data;
    }
    wxVector<FunctionsModel_Item*>& GetData() {
        return m_data;
    }
...
#endif // __FunctionsModel_GUARD__H__
