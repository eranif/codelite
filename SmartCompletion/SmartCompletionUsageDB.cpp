...
void SmartCompletionUsageDB::LoadUsageTable(std::unordered_map<wxString, int>& weightTable)
{
    try {
        weightTable.clear();
...
void SmartCompletionUsageDB::StoreUsage(const wxString& key, int weight)
{
    try {
        m_db.Begin();
