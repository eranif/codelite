...
void wxC38D8InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/wxcrafter_subversion2_bitmaps.cpp$C__src_codelite_Subversion2_wxcrafter_subversion2_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
