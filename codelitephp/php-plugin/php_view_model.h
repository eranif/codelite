...
public:
    ...
    wxString GetFolderName() const { return folderPath.AfterLast('/'); }
...
public:
    ...
    virtual void UpdateItem(const wxDataViewItem& item,
                            const wxVector<wxVariant>& data,
                            const wxString& old_filename,
                            const wxString& new_filename);
