...
public:
    ...
    void SetParentName(const wxString& parentName) { this->m_parentName = parentName; }
    /*! \brief Set SELECT string */
    void SetSelect(const wxString& select) { this->m_select = select; }
    /*! \brief Get view name */
    const wxString& GetName() const { return m_name; }
    /*! \brief Get paretn name (database) */
    const wxString& GetParentName() const { return m_parentName; }
    /*! \brief Get SELECT string */
    const wxString& GetSelect() const { return m_select; }
