...
bool UnixProcessImpl::Write(const wxString& buff) { return Write(buff.ToStdString(wxConvUTF8)); }

bool UnixProcessImpl::WriteRaw(const wxString& buff) { return WriteRaw(buff.ToStdString(wxConvUTF8)); }
