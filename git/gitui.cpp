    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText42 =
        new wxStaticText(m_panel232, wxID_ANY, _("Path to git executable:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_staticText54 =
        new wxStaticText(m_panel232, wxID_ANY, _("Path to gitk executable:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_staticText246 =
        new wxStaticText(m_panel234, wxID_ANY, _("Global user name:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_staticText254 =
        new wxStaticText(m_panel234, wxID_ANY, _("Local repository user name:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_staticText258 =
        new wxStaticText(m_panel234, wxID_ANY, _("Local repository email:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_checkBoxTrackTree = new wxCheckBox(
        m_panel236, wxID_ANY, _("Colour modified items in the workspace view"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_splitterMain = new wxSplitterWindow(
        this, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxSP_LIVE_UPDATE | wxSP_NO_XP_THEME | wxSP_3DSASH);
    ...
    m_splitterInner = new wxSplitterWindow(
        m_panel3, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxSP_LIVE_UPDATE | wxSP_NO_XP_THEME | wxSP_3DSASH);
    ...
    m_checkBoxAmend =
        new wxCheckBox(m_panel4, wxID_ANY, _("Amend the previous commit"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    // Connect events
    m_listBox->Connect(
        wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler(GitCommitDlgBase::OnChangeFile), NULL, this);
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText207 =
        new wxStaticText(m_splitterPage178, wxID_ANY, _("Commit list:"), wxDefaultPosition, wxSize(-1, -1), 0);

    boxSizer205->Add(m_staticText207, 0, wxALL, 5);

    m_dvListCtrlCommitList = new wxDataViewListCtrl(
        m_splitterPage178, wxID_ANY, wxDefaultPosition, wxSize(500, -1), wxDV_ROW_LINES | wxDV_SINGLE);
    ...
    m_splitter186 = new wxSplitterWindow(m_splitterPage182,
                                         wxID_ANY,
                                         wxDefaultPosition,
                                         wxSize(-1, -1),
    ...
    m_splitter196 = new wxSplitterWindow(m_splitterPage190,
                                         wxID_ANY,
                                         wxDefaultPosition,
                                         wxSize(-1, -1),
                                         wxSP_LIVE_UPDATE | wxSP_NO_XP_THEME | wxSP_3DSASH);
    ...
    m_staticText210 =
        new wxStaticText(m_splitterPage200, wxID_ANY, _("Modified files:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    m_staticText220 =
        new wxStaticText(m_splitterPage194, wxID_ANY, _("Commit message:"), wxDefaultPosition, wxSize(-1, -1), 0);

    boxSizer218->Add(m_staticText220, 0, wxALL, 5);

    m_stcCommitMessage =
        new wxStyledTextCtrl(m_splitterPage194, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxBORDER_THEME);
    // Configure the fold margin
    m_stcCommitMessage->SetMarginType(4, wxSTC_MARGIN_SYMBOL);
    m_stcCommitMessage->SetMarginMask(4, wxSTC_MASK_FOLDERS);
    m_stcCommitMessage->SetMarginSensitive(4, true);
    ...
    m_dvListCtrlCommitList->Connect(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED,
                                    wxDataViewEventHandler(GitCommitListDlgBase::OnSelectionChanged),
                                    NULL,
                                    this);
    m_dvListCtrlCommitList->Connect(wxEVT_COMMAND_DATAVIEW_ITEM_CONTEXT_MENU,
                                    wxDataViewEventHandler(GitCommitListDlgBase::OnContextMenu),
                                    NULL,
                                    this);
...
GitCommitListDlgBase::~GitCommitListDlgBase()
{
    ...
    m_fileListBox->Disconnect(
        wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler(GitCommitListDlgBase::OnChangeFile), NULL, this);
    m_button292->Disconnect(
        wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(GitCommitListDlgBase::OnOK), NULL, this);
}
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText68 =
        new wxStaticText(m_splitterPageFiles, wxID_ANY, _("Modified files:"), wxDefaultPosition, wxSize(-1, -1), 0);

    boxSizer62->Add(m_staticText68, 0, wxALL | wxALIGN_BOTTOM, 5);

    wxArrayString m_fileListBoxArr;
    m_fileListBox =
        new wxListBox(m_splitterPageFiles, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), m_fileListBoxArr, 0);
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText168 =
        new wxStaticText(this, wxID_ANY, _("git apply additional flags to use:"), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_auibar = new wxAuiToolBar(this,
                                wxID_ANY,
                                wxDefaultPosition,
                                wxSize(-1, -1),
    ...
    m_auibar->AddTool(XRCID("git_clear_log"),
                      _("Clear Log"),
                      wxXmlResource::Get()->LoadBitmap(wxT("clear")),
                      wxNullBitmap,
                      wxITEM_NORMAL,
                      _("Clear Log"),
                      _("Clear Log"),
    ...
    m_auibar->AddTool(wxID_ABORT,
                      _("m_toolKill"),
                      wxXmlResource::Get()->LoadBitmap(wxT("stop")),
                      wxNullBitmap,
                      wxITEM_NORMAL,
    ...
    m_auibar->AddTool(XRCID("git_console_add_file"),
                      _("Add file"),
                      wxXmlResource::Get()->LoadBitmap(wxT("git-add-file")),
                      wxNullBitmap,
                      wxITEM_NORMAL,
                      _("Add file"),
                      _("Add file"),
    ...
    m_auibar->AddTool(XRCID("git_console_reset_file"),
                      _("Reset File"),
                      wxXmlResource::Get()->LoadBitmap(wxT("git-reset")),
                      wxNullBitmap,
                      wxITEM_NORMAL,
                      _("Reset File"),
                      _("Reset File"),
    ...
    m_dvFiles = new wxDataViewCtrl(m_splitterPageTreeView,
                                   wxID_ANY,
                                   wxDefaultPosition,
                                   wxSize(-1, -1),
                                   wxDV_NO_HEADER | wxDV_MULTIPLE | wxBORDER_THEME);
    ...
    m_dvFiles->AppendIconTextColumn(
        _("File View"), m_dvFiles->GetColumnCount(), wxDATAVIEW_CELL_INERT, 400, wxALIGN_LEFT);
    ...
    m_gauge =
        new wxGauge(m_panelProgress, wxID_ANY, 100, wxDefaultPosition, wxSize(-1, -1), wxGA_SMOOTH | wxGA_HORIZONTAL);
    m_gauge->SetValue(10);
    ...
    // Connect events
    this->Connect(
        XRCID("git_clear_log"), wxEVT_UPDATE_UI, wxUpdateUIEventHandler(GitConsoleBase::OnClearGitLogUI), NULL, this);
    this->Connect(XRCID("git_clear_log"),
                  wxEVT_COMMAND_MENU_SELECTED,
                  wxCommandEventHandler(GitConsoleBase::OnClearGitLog),
                  NULL,
                  this);
    this->Connect(
        wxID_ABORT, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler(GitConsoleBase::OnStopGitProcess), NULL, this);
    this->Connect(wxID_ABORT, wxEVT_UPDATE_UI, wxUpdateUIEventHandler(GitConsoleBase::OnStopGitProcessUI), NULL, this);
    this->Connect(XRCID("git_console_add_file"),
                  wxEVT_COMMAND_TOOL_CLICKED,
                  wxCommandEventHandler(GitConsoleBase::OnAddFile),
                  NULL,
                  this);
    this->Connect(XRCID("git_console_add_file"),
                  wxEVT_UPDATE_UI,
                  wxUpdateUIEventHandler(GitConsoleBase::OnItemSelectedUI),
                  NULL,
                  this);
    this->Connect(XRCID("git_console_reset_file"),
                  wxEVT_COMMAND_TOOL_CLICKED,
                  wxCommandEventHandler(GitConsoleBase::OnResetFile),
                  NULL,
                  this);
    this->Connect(XRCID("git_console_reset_file"),
                  wxEVT_UPDATE_UI,
...
GitConsoleBase::~GitConsoleBase()
{
    this->Disconnect(
        XRCID("git_clear_log"), wxEVT_UPDATE_UI, wxUpdateUIEventHandler(GitConsoleBase::OnClearGitLogUI), NULL, this);
    this->Disconnect(XRCID("git_clear_log"),
                     wxEVT_COMMAND_MENU_SELECTED,
                     wxCommandEventHandler(GitConsoleBase::OnClearGitLog),
                     NULL,
                     this);
    this->Disconnect(
        wxID_ABORT, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler(GitConsoleBase::OnStopGitProcess), NULL, this);
    this->Disconnect(
        wxID_ABORT, wxEVT_UPDATE_UI, wxUpdateUIEventHandler(GitConsoleBase::OnStopGitProcessUI), NULL, this);
    this->Disconnect(XRCID("git_console_add_file"),
                     wxEVT_COMMAND_TOOL_CLICKED,
                     wxCommandEventHandler(GitConsoleBase::OnAddFile),
                     NULL,
                     this);
    this->Disconnect(XRCID("git_console_add_file"),
                     ...
                     NULL,
                     this);
    this->Disconnect(XRCID("git_console_reset_file"),
                     wxEVT_COMMAND_TOOL_CLICKED,
                     wxCommandEventHandler(GitConsoleBase::OnResetFile),
                     NULL,
                     this);
