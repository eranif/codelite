...
void wxC682BInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/wxcrafter_outline_bitmaps.cpp$._wxcrafter_outline_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/wxcrafter_outline_bitmaps.cpp$._wxcrafter_outline_bitmaps.xrc"));
}
