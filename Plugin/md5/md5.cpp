...
unsigned int MD5::rotate_left(uint4 x, uint4 n) { return (x << n) | (x >> (32 - n)); }

// F, G, H and I are basic MD5 functions.

unsigned int MD5::F(uint4 x, uint4 y, uint4 z) { return (x & y) | (~x & z); }

unsigned int MD5::G(uint4 x, uint4 y, uint4 z) { return (x & z) | (y & ~z); }

unsigned int MD5::H(uint4 x, uint4 y, uint4 z) { return x ^ y ^ z; }

unsigned int MD5::I(uint4 x, uint4 y, uint4 z) { return y ^ (x | ~z); }
