...
void wxC126AInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/clResizableTooltipBase_plugin_bitmaps.cpp$C__src_codelite_Plugin_clResizableTooltipBase_plugin_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/clResizableTooltipBase_plugin_bitmaps.cpp$C__src_codelite_Plugin_clResizableTooltipBase_plugin_bitmaps.xrc"));
}
