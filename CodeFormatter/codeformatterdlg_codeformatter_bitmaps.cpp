...
void wxCrafterGgLOZbInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/"
                     "codeformatterdlg_codeformatter_bitmaps.cpp$C__src_codelite_CodeFormatter_codeformatterdlg_"
                     "codeformatter_bitmaps.xrc"),
                 xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/"
                                   "codeformatterdlg_codeformatter_bitmaps.cpp$C__src_codelite_CodeFormatter_"
