...
// file name            : VirtualDirectorySelector_plugin_bitmaps.cpp
//
// -------------------------------------------------------------------------
// A
//              _____           _      _     _ _
...
static unsigned char xml_res_file_0[] = {
    ...
    46,  119, 120, 119, 105, 110, 100, 111, 119, 115, 46,  111, 114, 103, 47,  119, 120, 120, 114, 99,  34,  32,
    118, 101, 114, 115, 105, 111, 110, 61,  34,  50,  46,  51,  46,  48,  46,  49,  34,  47,  62,  10
};
...
void wxCD372InitBitmapResources()
{
    ...
    XRC_ADD_FILE(
        wxT("XRC_resource/VirtualDirectorySelector_plugin_bitmaps.cpp$._VirtualDirectorySelector_plugin_bitmaps.xrc"),
        xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(
        wxT("memory:XRC_resource/"
            "VirtualDirectorySelector_plugin_bitmaps.cpp$._VirtualDirectorySelector_plugin_bitmaps.xrc"));
}
