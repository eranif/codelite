    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_staticText1 = new wxStaticText(
        m_panelMainPanel, wxID_ANY, _("Find :"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);

    fgSizer41->Add(m_staticText1, 0, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    wxArrayString m_findStringArr;
    m_findString = new wxComboBox(m_panelMainPanel,
                                  wxID_ANY,
                                  wxT(""),
                                  wxDefaultPosition,
                                  wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
                                  m_findStringArr,
                                  wxTE_PROCESS_ENTER);
    ...
    m_find = new wxButton(
        m_panelMainPanel, wxID_OK, _("&Find"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    m_find->SetDefault();
    ...
    m_staticText102 = new wxStaticText(
        m_panelMainPanel, wxID_ANY, _("Replace:"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_replaceString = new wxComboBox(m_panelMainPanel,
                                     wxID_ANY,
                                     wxT(""),
                                     wxDefaultPosition,
                                     wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
    ...
    m_replaceAll = new wxButton(m_panelMainPanel,
                                wxID_REPLACE,
                                _("&Replace"),
                                wxDefaultPosition,
                                wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
    ...
    m_staticText3 = new wxStaticText(
        m_panelMainPanel, wxID_ANY, _("Files:"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_fileTypes = new wxComboBox(m_panelMainPanel,
                                 wxID_ANY,
                                 wxT("*.c;*.cpp;*.cxx;*.cc;*.h;*.hpp;*.inc;*.mm;*.m;*.xrc"),
                                 wxDefaultPosition,
                                 wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
                                 m_fileTypesArr,
                                 wxTE_PROCESS_ENTER);
    ...
    m_staticText2 = new wxStaticText(
        m_panelMainPanel, wxID_ANY, _("Where:"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_comboBoxWhere = new wxComboBox(m_panelMainPanel,
                                     wxID_ANY,
                                     wxT(""),
                                     wxDefaultPosition,
                                     wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
    ...
    m_btnAddPath = new wxButton(
        m_panelMainPanel, wxID_ANY, _("..."), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    m_btnAddPath->SetToolTip(_("Add new search location"));

    fgSizer41->Add(m_btnAddPath, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_staticText5 = new wxStaticText(
        m_panelMainPanel, wxID_ANY, _("Encoding:"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_comboBoxEncoding = new wxComboBox(m_panelMainPanel,
                                        wxID_ANY,
                                        wxT(""),
                                        wxDefaultPosition,
                                        wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
                                        m_comboBoxEncodingArr,
                                        wxTE_PROCESS_ENTER | wxCB_READONLY);

    fgSizer41->Add(m_comboBoxEncoding, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_cancel = new wxButton(
        m_panelMainPanel, wxID_CANCEL, _("Close"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    gridBagSizer174->Add(
        staticBoxSizer170, wxGBPosition(0, 0), wxGBSpan(1, 2), wxALL | wxEXPAND | wxALIGN_LEFT, WXC_FROM_DIP(5));

    m_matchCase = new wxCheckBox(
        m_panelMainPanel, wxID_ANY, _("Case"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_matchWholeWord = new wxCheckBox(
        m_panelMainPanel, wxID_ANY, _("Word"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_regualrExpression = new wxCheckBox(
        m_panelMainPanel, wxID_ANY, _("Regex"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_checkBoxPipeForGrep = new wxCheckBox(m_panelMainPanel,
                                           wxID_ANY,
                                           _("Pipe filter"),
                                           wxDefaultPosition,
                                           wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
    ...
    m_checkBoxSaveFilesBeforeSearching = new wxCheckBox(m_panelMainPanel,
                                                        wxID_ANY,
                                                        _("Save before"),
                                                        wxDefaultPosition,
                                                        wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
    ...
    m_checkBoxFollowSymlinks = new wxCheckBox(
        m_panelMainPanel, wxID_ANY, _("Symlinks"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_checkBoxIncludeHiddenFolders = new wxCheckBox(m_panelMainPanel,
                                                    wxID_ANY,
                                                    _("Hidden folders"),
                                                    wxDefaultPosition,
                                                    wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)),
    ...
    m_checkBoxTODO = new wxCheckBox(
        m_panelMainPanel, wxID_ANY, _("TODO"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_checkBoxATTN = new wxCheckBox(
        m_panelMainPanel, wxID_ANY, _("ATTN"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_checkBoxBUG = new wxCheckBox(
        m_panelMainPanel, wxID_ANY, _("BUG"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    m_checkBoxFIXME = new wxCheckBox(
        m_panelMainPanel, wxID_ANY, _("FIXME"), wxDefaultPosition, wxDLG_UNIT(m_panelMainPanel, wxSize(-1, -1)), 0);
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_checkListBoxLocations = new wxCheckListBox(
        this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), m_checkListBoxLocationsArr, wxLB_SINGLE);
