...
void wxCAD0CInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/compiler_page_plugin_bitmaps.cpp$._compiler_page_plugin_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/compiler_page_plugin_bitmaps.cpp$._compiler_page_plugin_bitmaps.xrc"));
}
