...
#include "edit_configuration_base.hpp"

///////////////////////////////////////////////////////////////////////////////
/// Class EditConfigurationDialog
///////////////////////////////////////////////////////////////////////////////
class EditConfigurationDialog : public EditConfigurationDialogBase
{
protected:
...
public:
    EditConfigurationDialog(wxWindow* parent,
                            const wxString& projectName,
                            int id = wxID_ANY,
                            wxString title = _("Edit Configurations"),
                            wxPoint pos = wxDefaultPosition,
                            wxSize size = wxSize(338, 199),
