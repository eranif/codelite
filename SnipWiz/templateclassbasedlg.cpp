...
TemplateClassBaseDlg::TemplateClassBaseDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_static1 = new wxStaticText( ID_PANEL, wxID_ANY, wxT("Class name:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_static1->Wrap( -1 );
	...
	m_textCtrlClassName->SetToolTip( wxT("Name of new class") );
	
	fgSizer1->Add( m_textCtrlClassName, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxEXPAND|wxALL, 5 );
	
	m_static2 = new wxStaticText( ID_PANEL, wxID_ANY, wxT("Template:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_static2->Wrap( -1 );
	...
	m_comboxCurrentTemplate->SetToolTip( wxT("Template for new class") );
	...
	m_static3 = new wxStaticText( ID_PANEL, wxID_ANY, wxT(".h filename:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_static3->Wrap( -1 );
	...
	m_textCtrlHeaderFile->SetToolTip( wxT("Name of header file") );
	...
	m_static4 = new wxStaticText( ID_PANEL, wxID_ANY, wxT(".cpp filename:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_static4->Wrap( -1 );
	...
	m_textCtrlCppFile->SetToolTip( wxT("Name of source file") );
	...
	m_staticProjectTreeFolder = new wxStaticText( ID_PANEL, wxID_ANY, wxT("Project tree folder:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_textCtrlVD->SetToolTip( wxT("Virtual folder to add new files") );
	
	fgSizer2->Add( m_textCtrlVD, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_buttonBrowseVD = new wxButton( ID_PANEL, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	m_buttonBrowseVD->SetDefault(); 
	m_buttonBrowseVD->SetToolTip( wxT("Browse virtual folders") );
	
	fgSizer2->Add( m_buttonBrowseVD, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxRIGHT, 5 );
	
	m_static5 = new wxStaticText( ID_PANEL, wxID_ANY, wxT("Path:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_static5->Wrap( -1 );
	...
	m_textCtrlFilePath->SetToolTip( wxT("Hd folder to add new files") );
	
	fgSizer2->Add( m_textCtrlFilePath, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_buttonBrowsePath = new wxButton( ID_PANEL, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	m_buttonBrowsePath->SetDefault(); 
	m_buttonBrowsePath->SetToolTip( wxT("Browse  folders") );
	...
	m_buttonGenerate = new wxButton( ID_PANEL, wxID_OK, wxT("&Generate"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_static6 = new wxStaticText( ID_PANEL1, wxID_ANY, wxT("Class:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_static6->Wrap( -1 );
	...
	m_buttonAddTemplate = new wxButton( ID_PANEL1, wxID_ANY, wxT("Add"), wxDefaultPosition, wxDefaultSize, 0 );
	m_buttonAddTemplate->SetDefault(); 
	bSizer5->Add( m_buttonAddTemplate, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1 );
	
	m_buttonChangeTemplate = new wxButton( ID_PANEL1, wxID_ANY, wxT("Change"), wxDefaultPosition, wxDefaultSize, 0 );
	m_buttonChangeTemplate->SetDefault(); 
	bSizer5->Add( m_buttonChangeTemplate, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1 );
	
	m_buttonRemoveTemplate = new wxButton( ID_PANEL1, wxID_ANY, wxT("Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	m_buttonRemoveTemplate->SetDefault(); 
	bSizer5->Add( m_buttonRemoveTemplate, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1 );
	
	m_buttonClear = new wxButton( ID_PANEL1, wxID_ANY, wxT("Clear"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer5->Add( m_buttonClear, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1 );
	
	m_buttonInsertClassMacro = new wxButton( ID_PANEL1, wxID_ANY, wxT("%CLASS%"), wxDefaultPosition, wxDefaultSize, 0 );
