...
void wxC32BEInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/UI_sftp_bitmaps.cpp$_Users_eifrah_devl_codelite_SFTP_UI_sftp_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/UI_sftp_bitmaps.cpp$_Users_eifrah_devl_codelite_SFTP_UI_sftp_bitmaps.xrc"));
}
