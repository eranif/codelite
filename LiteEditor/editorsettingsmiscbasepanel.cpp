    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_toolGroupSpacing = new wxTextCtrl(m_panelTBar, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelTBar, wxSize(-1,-1)), 0);
    m_toolGroupSpacing->SetToolTip(_("The tools on the toolbar are grouped by their function e.g. Edit, Build. By default those groups are separated by little more than a vertical line. Here you can adjust the amount of space between them."));
#if wxVERSION_NUMBER >= 3000
    m_toolGroupSpacing->SetHint(wxT(""));
#endif

    boxSizer95->Add(m_toolGroupSpacing, 1, wxALL|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
