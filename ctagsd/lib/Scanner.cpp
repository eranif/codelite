...
void Scanner::scan(const wxFileName& current_file,
                   const wxArrayString& search_path,
...
void Scanner::scan_buffer(const wxFileName& current_file,
...
bool Scanner::IsFileExists(const wxString& current_dir,
                           const wxString& name,
                           const wxArrayString& search_path,
                           std::set<wxString>& fixed_path)
{
