...
: wxWizardPageSimple(parent)
{
	...
	wxString selection = TagsManagerST::Get()->GetExtDatabase()->GetDatabaseFileName().GetFullPath();
	m_comboDbName = new wxComboBox(m_panel1, wxID_ANY, selection, wxDefaultPosition, wxDefaultSize, data.GetFiles());
