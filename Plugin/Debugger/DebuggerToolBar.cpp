...
DebuggerToolBar::DebuggerToolBar(wxWindow* parent)
{
    ...
    m_tb->AddTool(
        XRCID("restart_debugger"), _("Restart debugger"), images->Add("debugger_restart"), _("Restart debugger"));
    m_tb->AddTool(
        XRCID("show_cursor"), _("Show Current Line"), images->Add("show_current_line"), _("Show Current Line"));
    ...
    m_tb->AddSeparator();
    m_tb->AddTool(XRCID("dbg_enable_reverse_debug"),
                  _("Toggle Rewind Commands"),
                  images->Add("rewind"),
                  _("Toggle Rewind Commands"),
                  wxITEM_CHECK);
    m_tb->AddTool(XRCID("dbg_start_recording"),
