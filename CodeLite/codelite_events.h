...
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_REQUEST, clLLMEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_RESPONSE, clLLMEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_IS_AVAILABLE, clLLMEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_RESPONSE_ERROR, clLLMEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_RESPONSE_ABORTED, clLLMEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_RESPONSE_COMPLETED, clLLMEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_UNREGISTER_FUNC, clLLMEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_RESTART, clLLMEvent);
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_CL, wxEVT_LLM_RESTARTED, clLLMEvent);
