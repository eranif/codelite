    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_checkBox1 = new wxCheckBox(this, wxID_ANY, _("Enable continuous build"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_buttonCancel = new wxButton(this, wxID_ANY, _("&Clear All"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_listBoxQueue = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), m_listBoxQueueArr, 0);
    ...
    m_staticText4 = new wxStaticText(this, wxID_ANY, _("Failed Files:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_listBoxFailedFiles = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), m_listBoxFailedFilesArr, 0);
