...
{
    const std::vector<wxString> fold_styles = {
        wxT("Simple"), wxT("Arrows"), wxT("Flatten Tree Square Headers"), wxT("Flatten Tree Circular Headers")};
    ...
    AddProperty(_("Highlight active fold block"),
                m_options->IsHighlightFoldWhenActive(),
