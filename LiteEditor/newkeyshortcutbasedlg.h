...
class NewKeyShortcutBaseDlg : public wxDialog 
{
	...
	public:
		...
		NewKeyShortcutBaseDlg( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Set New Key Accelerator:"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 516,187 ), long style = wxDEFAULT_DIALOG_STYLE ); 
