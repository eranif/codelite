...
void wxCB786InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/newquickwatch_liteeditor_bitmaps.cpp$C__src_codelitegit_LiteEditor_newquickwatch_liteeditor_bitmaps.xrc"), xml_res_file_1, xml_res_size_1, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/newquickwatch_liteeditor_bitmaps.cpp$C__src_codelitegit_LiteEditor_newquickwatch_liteeditor_bitmaps.xrc"));
}
