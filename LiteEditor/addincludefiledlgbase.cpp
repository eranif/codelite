...
AddIncludeFileDlgBase::AddIncludeFileDlgBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_textCtrlPreview = new wxStyledTextCtrl( m_mainPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, wxEmptyString );
	...
	m_textCtrlPreview->SetMarginWidth( 0, m_textCtrlPreview->TextWidth( wxSTC_STYLE_LINENUMBER, wxT("_99999") ) );
