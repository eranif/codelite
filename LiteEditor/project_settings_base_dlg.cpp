    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_buttonHelp = new wxButton(this, wxID_HELP, _("Help..."), wxDefaultPosition, wxSize(-1, -1), 0);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText44 = new wxStaticText(m_generalPage, wxID_ANY, _("Debug Arguments:"), wxDefaultPosition, wxSize(-1, -1), 0);
    
    flexGridSizer6->Add(m_staticText44, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
    ...
    m_staticline11 = new wxStaticLine(m_generalPage, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxLI_HORIZONTAL);
    
    bSizer19->Add(m_staticline11, 0, wxALL|wxEXPAND, 5);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_listCtrlTargets = new wxListCtrl(m_customBuildPage, wxID_ANY, wxDefaultPosition, wxSize(-1, -1), wxLC_VRULES|wxLC_HRULES|wxLC_SINGLE_SEL|wxLC_REPORT);
