...
void wxCrafterWdIahzInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/eosUI_eoswiki_bitmaps.cpp$_home_eran_devl_codelite-eos_EOSWiki_eosUI_eoswiki_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/eosUI_eoswiki_bitmaps.cpp$_home_eran_devl_codelite-eos_EOSWiki_eosUI_eoswiki_bitmaps.xrc"));
}
