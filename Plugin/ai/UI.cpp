    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    wxBoxSizer* boxSizer217 = new wxBoxSizer(wxVERTICAL);

    boxSizer213->Add(boxSizer217, 1, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_staticTextMessage =
        new wxStaticText(this, wxID_ANY, _("Mesage"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);

    boxSizer217->Add(m_staticTextMessage, 0, wxALL | wxALIGN_LEFT, WXC_FROM_DIP(5));
    ...
    boxSizer217->Add(m_dvListCtrlOptions, 1, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_dvListCtrlOptions->AppendTextColumn(_("Name"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT, 0);
    m_checkBox = new wxCheckBox(this, wxID_ANY, _("Persist"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_checkBox->SetValue(false);

    boxSizer217->Add(m_checkBox, 0, wxALL, WXC_FROM_DIP(5));

    m_stdBtnSizer214 = new wxStdDialogButtonSizer();

    boxSizer213->Add(m_stdBtnSizer214, 0, wxALL | wxALIGN_CENTER_HORIZONTAL, WXC_FROM_DIP(10));

    m_button215 = new wxButton(this, wxID_OK, wxT(""), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_button215->SetDefault();
    m_stdBtnSizer214->AddButton(m_button215);

    m_button216 = new wxButton(this, wxID_CANCEL, wxT(""), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    m_stdBtnSizer214->AddButton(m_button216);
    m_stdBtnSizer214->Realize();

    SetName(wxT("ToolTrustLevelDlgBase"));
    SetSize(wxDLG_UNIT(this, wxSize(-1, -1)));
    if (GetSizer()) {
        GetSizer()->Fit(this);
    }
