    ...
    : wxcWidget(ID_WXTREELISTCTRL)
{
    ...
    RegisterEvent("wxEVT_TREELIST_ITEM_EXPANDING",
                  "wxTreeListEvent",
    ...
    RegisterEvent("wxEVT_TREELIST_ITEM_ACTIVATED",
                  "wxTreeListEvent",
