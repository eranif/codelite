...
static unsigned char xml_res_file_1[] = {
    ...
    115, 115, 61,  34,  119, 120, 66,  105, 116, 109, 97,  112, 34,  32,  110, 97,  109, 101, 61,  34,  49,  54,  45,
    99,  111, 110, 110, 101, 99,  116, 101, 100, 34,  62,  115, 102, 116, 112, 95,  117, 105, 95,  115, 102, 116, 112,
    95,  98,  105, 116, 109, 97,  112, 115, 46,  99,  112, 112, 36,  46,  46,  95,  98,  105, 116, 109, 97,  112, 115,
    95,  49,  54,  45,  99,  111, 110, 110, 101, 99,  116, 101, 100, 46,  112, 110, 103, 60,  47,  111, 98,  106, 101,
...
void wxCE8CInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/sftp_ui_sftp_bitmaps.cpp$.._bitmaps_16-connected.png"), xml_res_file_0,
                 xml_res_size_0, wxT("image/png"));
    XRC_ADD_FILE(wxT("XRC_resource/sftp_ui_sftp_bitmaps.cpp$C__src_codelite_Plugin_sftp_ui_sftp_bitmaps.xrc"),
                 xml_res_file_1, xml_res_size_1, wxT("text/xml"));
    wxXmlResource::Get()->Load(
        wxT("memory:XRC_resource/sftp_ui_sftp_bitmaps.cpp$C__src_codelite_Plugin_sftp_ui_sftp_bitmaps.xrc"));
}
