...
{
    const wxArrayString backendList = {
        "", // Default empty
    ...
    RegisterEvent(
        "wxEVT_MEDIA_LOADED", "wxMediaEvent", _("Sent when a media has loaded enough data that it can start playing"));
    RegisterEvent("wxEVT_MEDIA_STOP",
                  "wxMediaEvent",
    ...
    RegisterEvent(
        "wxEVT_MEDIA_FINISHED", "wxMediaEvent", _("Sent when a media has finished playing in a wxMediaCtrl."));
    RegisterEvent("wxEVT_MEDIA_STATECHANGED",
                  "wxMediaEvent",
    ...
    RegisterEvent(
        "wxEVT_MEDIA_PAUSE", "wxMediaEvent", _("Sent when a media has switched to the wxMEDIASTATE_PAUSED state"));
