...
static size_t xml_res_size_2 = 343;
...
97,110,34,62,85,73,95,108,108,100,98,100,101,98,117,103,103,101,114,95,
...
120,66,105,116,109,97,112,34,32,110,97,109,101,61,34,49,54,45,112,108,117,
115,34,62,85,73,95,108,108,100,98,100,101,98,117,103,103,101,114,95,98,
105,116,109,97,112,115,46,99,112,112,36,46,46,95,98,105,116,109,97,112,
115,95,49,54,45,112,108,117,115,46,112,110,103,60,47,111,98,106,101,99,
...
void wxCrafternz79PnInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/UI_lldbdebugger_bitmaps.cpp$.._bitmaps_16-clean.png"), xml_res_file_0, xml_res_size_0, wxT("image/png"));
    XRC_ADD_FILE(wxT("XRC_resource/UI_lldbdebugger_bitmaps.cpp$.._bitmaps_16-plus.png"), xml_res_file_1, xml_res_size_1, wxT("image/png"));
    XRC_ADD_FILE(wxT("XRC_resource/UI_lldbdebugger_bitmaps.cpp$_home_eran_devl_codelite_LLDBDebugger_UI_lldbdebugger_bitmaps.xrc"), xml_res_file_2, xml_res_size_2, wxT("text/xml"));
