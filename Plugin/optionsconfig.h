...
public:
    enum {
        ...
        Opt_IconSet_Classic = (1 << 7),
        Opt_AutoCompleteDoubleQuotes = (1 << 8),
        Opt_NavKey_Shift = (1 << 9), // (No longer actively used)
        Opt_NavKey_Alt = (1 << 10),
        Opt_NavKey_Control = (1 << 11),
        Opt_IconSet_Classic_Dark = (1 << 12),
        Opt_Mark_Debugger_Line = (1 << 13),
        Opt_TabNoXButton = (1 << 14),
        Opt_TabColourPersistent = (1 << 15),
        Opt_TabColourDark = (1 << 16),
        Opt_Use_CodeLite_Terminal = (1 << 17),
        Opt_Unused6 = (1 << 18),
        Opt_Unused5 = (1 << 19),
        Opt_AllowCaretAfterEndOfLine = (1 << 20),
        Opt_HideDockingWindowCaption = (1 << 21),
        Opt_WrapQuotes = (1 << 22),
        Opt_WrapBrackets = (1 << 23),
        Opt_WrapCmdWithDoubleQuotes = (1 << 24),
        Opt_FoldHighlightActiveBlock = (1 << 25),
        Opt_EnsureCaptionsVisible = (1 << 26),
        Opt_DisableMouseCtrlZoom = (1 << 27),
        Opt_UseBlockCaret = (1 << 28),
        Opt_TabStyleMinimal = (1 << 29),
        Opt_TabStyleTRAPEZOID = (1 << 30),
    };
