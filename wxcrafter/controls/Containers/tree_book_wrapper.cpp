    ...
    : NotebookBaseWrapper(ID_WXTREEBOOK)
{
    ...
    RegisterEvent(
        wxT("wxEVT_COMMAND_TREEBOOK_PAGE_CHANGED"), wxT("wxTreebookEvent"), _("The page selection was changed"));
    RegisterEvent(wxT("wxEVT_COMMAND_TREEBOOK_PAGE_CHANGING"),
                  wxT("wxTreebookEvent"),
                  _("The page selection is about to be changed. This event can be vetoed"));
    RegisterEvent(wxT("wxEVT_COMMAND_TREEBOOK_NODE_COLLAPSED"),
                  wxT("wxTreebookEvent"),
                  _("The page node is going to be collapsed"));
    RegisterEvent(wxT("wxEVT_COMMAND_TREEBOOK_NODE_EXPANDED"),
                  wxT("wxTreebookEvent"),
