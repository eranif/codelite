...
void NotebookFrame::Initialize()
{
	...
	book2->AddPage(new wxTextCtrl(book2, wxID_ANY), wxT("Page 1"));
	book2->AddPage(new wxTextCtrl(book2, wxID_ANY), wxT("Page 2 With Long"));
	book2->AddPage(new wxTextCtrl(book2, wxID_ANY), wxT("Page 3 With"));
	...
	book4->AddPage(new wxTextCtrl(book4, wxID_ANY), wxT("Page 1"));
	book4->AddPage(new wxTextCtrl(book4, wxID_ANY), wxT("Page 2"));
	book4->AddPage(new wxTextCtrl(book4, wxID_ANY), wxT("Page 3"));
	book4->AddPage(new wxTextCtrl(book4, wxID_ANY), wxT("Page 4"));
