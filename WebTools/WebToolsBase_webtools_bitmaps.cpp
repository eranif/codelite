...
void wxCD9C6InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/WebToolsBase_webtools_bitmaps.cpp$C__src_codelite_WebTools_WebToolsBase_webtools_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
