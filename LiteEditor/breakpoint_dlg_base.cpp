...
BreakpointTab::BreakpointTab( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_buttonDeleteAll = new wxButton( this, wxID_ANY, _("Delete &All"), wxDefaultPosition, wxDefaultSize, 0 );
	m_buttonDeleteAll->SetToolTip( _("Delete all breakpoints and watchpoints") );
	
	bSizer6->Add( m_buttonDeleteAll, 0, wxALL, 5 );
	
	m_buttonApplyPending = new wxButton( this, wxID_ANY, _("Set Pending"), wxDefaultPosition, wxDefaultSize, 0 );
...
BreakpointPropertiesDlg::BreakpointPropertiesDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText9 = new wxStaticText( this, wxID_ANY, _("Select the type of the breakpoint:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText51 = new wxStaticText( m_panel1, wxID_ANY, _("Break by line, function or memory address:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkLineno = new wxCheckBox( m_panel1, wxID_ANY, _("Line number"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkBreakFunction = new wxCheckBox( m_panel1, wxID_ANY, _("Function name"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkRegex = new wxCheckBox( m_panel1, wxID_ANY, _("This is a regex"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkBreakMemory = new wxCheckBox( m_panel1, wxID_ANY, _("Memory address:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText6 = new wxStaticText( m_panel1, wxID_ANY, _("In file: "), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_buttonBrowse = new wxButton( m_panel1, wxID_ANY, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_choicebook->AddPage( m_panel1, _("Breakpoint"), true );
	m_panel2 = new wxPanel( m_choicebook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer13;
	bSizer13 = new wxBoxSizer( wxVERTICAL );
	
	wxString m_radioWatchtypeChoices[] = { _("write only"), _("read only"), _("read-write") };
	int m_radioWatchtypeNChoices = sizeof( m_radioWatchtypeChoices ) / sizeof( wxString );
	m_radioWatchtype = new wxRadioBox( m_panel2, wxID_ANY, _("Type of watchpoint:"), wxDefaultPosition, wxDefaultSize, m_radioWatchtypeNChoices, m_radioWatchtypeChoices, 3, wxRA_SPECIFY_ROWS );
	...
	m_staticText5 = new wxStaticText( m_panel2, wxID_ANY, _("Data to watch:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, _("Conditional Breaks: Add any condition here"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText11 = new wxStaticText( this, wxID_ANY, _("Command List: Add any command(s) here"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkDisable = new wxCheckBox( this, wxID_ANY, _("Disable"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkTemp = new wxCheckBox( this, wxID_ANY, _("Make temporary"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText7 = new wxStaticText( this, wxID_ANY, _("Ignore count:"), wxDefaultPosition, wxDefaultSize, 0 );
