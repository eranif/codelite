...
wxToolBar *CodeFormatter::CreateToolBar(wxWindow *parent) {
    ...
    tb->AddTool(XRCID("format_source"), wxT("Format Source"), wxXmlResource::Get()->LoadBitmap(wxT("code_format")), wxT("Format Source Code"));
    tb->AddTool(XRCID("formatter_options"), wxT("Format Options"), wxXmlResource::Get()->LoadBitmap(wxT("code_format_options")), wxT("Source Code Formatter Options..."));
