...
ThemeImporterHTML::ThemeImporterHTML()
{
    ...
    SetFileExtensions("*.phtml;*.html");
}

LexerConf::Ptr_t ThemeImporterHTML::Import(const wxFileName& theme_file)
{
    LexerConf::Ptr_t lexer = InitializeImport(theme_file, "html", wxSTC_LEX_HTML);
