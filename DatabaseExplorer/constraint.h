...
public:
    ...
    enum constraintType { primaryKey, foreignKey, noKey };
    ...
    Constraint(const wxString& name,
               const wxString& localColumn,
               constraintType type,
    ...
    void SetRefCol(const wxString& refCol) { this->m_refCol = refCol; }
    /*! \brief Set reference table name */
    void SetRefTable(const wxString& refTable) { this->m_refTable = refTable; }
    /*! \brief Set constraint type */
    void SetType(constraintType type) { this->m_type = type; }
    /*! \brief Set action OnDelete */
    void SetOnDelete(constraintAction onDelete) { this->m_onDelete = onDelete; }
    /*! \brief Set action OnUpdate */
    void SetOnUpdate(constraintAction onUpdate) { this->m_onUpdate = onUpdate; }
    /*! \brief Get action OnDelete */
    constraintAction GetOnDelete() const { return m_onDelete; }
    /*! \brief Get action OnUpdate */
    constraintAction GetOnUpdate() const { return m_onUpdate; }
    /*! \brief Get local column name */
    const wxString& GetLocalColumn() const { return m_localColumn; }
    /*! \brief Get constraint name */
    const wxString& GetName() const { return m_name; }
    /*! \brief Get reference column name */
    const wxString& GetRefCol() const { return m_refCol; }
    /*! \brief Get reference table name */
    const wxString& GetRefTable() const { return m_refTable; }
