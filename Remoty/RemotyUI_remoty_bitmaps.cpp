...
void wxCrafterjtvK2XInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/RemotyUI_remoty_bitmaps.cpp$_home_ANT.AMAZON.COM_eifrah_devl_codelite_Remoty_RemotyUI_remoty_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/RemotyUI_remoty_bitmaps.cpp$_home_ANT.AMAZON.COM_eifrah_devl_codelite_Remoty_RemotyUI_remoty_bitmaps.xrc"));
}
