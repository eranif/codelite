...
static unsigned char xml_res_file_0[] = { 60,  63, 120, 109, 108, 32,  118, 101, 114, 115, 105, 111, 110, 61,  34,
                                          ...
                                          58,  47, 47,  119, 119, 119, 46,  119, 120, 119, 105, 100, 103, 101, 116,
...
void wxC934BInitBitmapResources()
{
    ...
    XRC_ADD_FILE(
        wxT("XRC_resource/nameanddescdlg_plugin_bitmaps.cpp$C__src_codelite_Plugin_nameanddescdlg_plugin_bitmaps.xrc"),
        xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(
        wxT("memory:XRC_resource/"
            "nameanddescdlg_plugin_bitmaps.cpp$C__src_codelite_Plugin_nameanddescdlg_plugin_bitmaps.xrc"));
}
