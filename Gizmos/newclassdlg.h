...
public:
    ...
    bool IsSingleton() {
        return m_checkBoxSingleton->GetValue();
    }
    wxString GetClassName() {
        return m_textClassName->GetValue();
    }
    wxString GetClassNamespace() const {
        return m_textCtrlNamespace->GetValue();
    }
    wxString GetClassPath();
    wxString GetClassFile();
    bool IsCopyableClass() {
        return !m_checkBoxCopyable->IsChecked();
    }
    wxString GetVirtualDirectoryPath() {
        return m_textCtrlVD->GetValue();
    }
    void GetNamespacesList(wxArrayString& namespacesArray);
    bool IsInline() const {
        return m_checkBoxInline->GetValue();
    }
    bool HppHeader() const {
        return m_checkBoxHpp->GetValue();
    }
};
