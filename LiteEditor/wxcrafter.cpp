    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_dvListCtrl = new clThemedListCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxDV_ROW_LINES|wxDV_SINGLE);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticBitmap = new wxStaticBitmap(m_panel191, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDLG_UNIT(m_panel191, wxSize(-1,-1)), 0 );
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_splitter = new wxSplitterWindow(m_panelCxx, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelCxx, wxSize(-1,-1)), wxSP_LIVE_UPDATE|wxSP_NO_XP_THEME|wxSP_3DSASH);
    m_splitter->SetSashGravity(0);
    m_splitter->SetMinimumPaneSize(10);

    boxSizer505->Add(m_splitter, 1, wxEXPAND, WXC_FROM_DIP(5));

    m_splitterPage617 = new wxPanel(m_splitter, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitter, wxSize(-1,-1)), wxTAB_TRAVERSAL);

    wxBoxSizer* boxSizer621 = new wxBoxSizer(wxVERTICAL);
    m_splitterPage617->SetSizer(boxSizer621);

    m_dvListCtrlPinnedProjects = new wxDataViewListCtrl(m_splitterPage617, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPage617, wxSize(-1,100)), wxDV_ROW_LINES|wxDV_SINGLE);

    boxSizer621->Add(m_dvListCtrlPinnedProjects, 1, wxEXPAND, WXC_FROM_DIP(5));

    m_splitterPage613 = new wxPanel(m_splitter, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitter, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    m_splitter->SplitHorizontally(m_splitterPage617, m_splitterPage613, 50);

    wxBoxSizer* boxSizer619 = new wxBoxSizer(wxVERTICAL);
    m_splitterPage613->SetSizer(boxSizer619);

    m_fileView = new FileViewTree(m_splitterPage613, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPage613, wxSize(-1,-1)), wxTR_MULTIPLE|wxTR_NO_LINES|wxTR_HAS_BUTTONS);
    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_toolbar = new clToolBar(m_mainPanel, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_mainPanel, wxSize(-1,-1)), wxTB_NOALIGN|wxTB_FLAT);
