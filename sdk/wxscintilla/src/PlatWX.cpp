...
void SurfaceImpl::RoundedRectangle(PRectangle rc, ColourAllocated fore, ColourAllocated back) {
    ...
    hdc->DrawRoundedRectangle(rr.Inflate(1), 2);
}
...
#else
bool Platform::WaitMouseMoved(Point pt) { return false; /*::Point mpt; mpt.v = pt.x; mpt.h = pt.y; return ::WaitMouseMoved(mpt);*/} // [CHANGED]#endif
#endif // [CHAMGED]
#endif
