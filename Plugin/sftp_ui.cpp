    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_toolbar =
        new wxToolBar(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTB_NODIVIDER | wxTB_FLAT);
    m_toolbar->SetToolBitmapSize(wxSize(16, 16));

    boxSizer62->Add(m_toolbar, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_toolbar->AddTool(ID_CD_UP, _("Parent folder"), wxXmlResource::Get()->LoadBitmap(wxT("16-up")), wxNullBitmap,
                       wxITEM_NORMAL, _("Parent folder"), _("Parent folder"), NULL);

    m_toolbar->AddTool(ID_SSH_ACCOUNT_MANAGER, _("Open SSH Account Manager..."),
                       wxXmlResource::Get()->LoadBitmap(wxT("16-folder-users")), wxNullBitmap, wxITEM_NORMAL,
                       _("Open SSH Account Manager..."), _("Open SSH Account Manager..."), NULL);
    m_toolbar->Realize();
    ...
    this->Connect(ID_SSH_ACCOUNT_MANAGER, wxEVT_COMMAND_TOOL_CLICKED,
                  wxCommandEventHandler(SFTPBrowserBaseDlg::OnSSHAccountManager), NULL, this);
...
SFTPBrowserBaseDlg::~SFTPBrowserBaseDlg()
{
    ...
    this->Disconnect(ID_CD_UP, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler(SFTPBrowserBaseDlg::OnCdUp), NULL,
                     this);
    this->Disconnect(ID_CD_UP, wxEVT_UPDATE_UI, wxUpdateUIEventHandler(SFTPBrowserBaseDlg::OnCdUpUI), NULL, this);
    this->Disconnect(ID_SSH_ACCOUNT_MANAGER, wxEVT_COMMAND_TOOL_CLICKED,
                     wxCommandEventHandler(SFTPBrowserBaseDlg::OnSSHAccountManager), NULL, this);
...
SSHTerminalBase::SSHTerminalBase(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
                                 const wxSize& size, long style)
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_auibar135 = new wxAuiToolBar(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)),
                                   wxAUI_TB_PLAIN_BACKGROUND | wxAUI_TB_DEFAULT_STYLE);
    m_auibar135->SetToolBitmapSize(wxSize(16, 16));

    boxSizer124->Add(m_auibar135, 0, wxEXPAND, WXC_FROM_DIP(5));

    m_auibar135->AddTool(wxID_CLEAR, _("Clear"), wxXmlResource::Get()->LoadBitmap(wxT("16-clear")), wxNullBitmap,
                         wxITEM_NORMAL, _("Clear"), _("Clear"), NULL);
    m_auibar135->Realize();

    m_panel126 = new wxPanel(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTAB_TRAVERSAL);

    boxSizer124->Add(m_panel126, 1, wxEXPAND, WXC_FROM_DIP(5));

    wxBoxSizer* boxSizer116 = new wxBoxSizer(wxVERTICAL);
    m_panel126->SetSizer(boxSizer116);

    m_stcOutput =
        new wxStyledTextCtrl(m_panel126, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel126, wxSize(-1, -1)), 0);
    ...
    boxSizer116->Add(m_stcOutput, 1, wxALL | wxEXPAND, WXC_FROM_DIP(2));

    m_textCtrl1 = new wxTextCtrl(m_panel126, wxID_ANY, wxT(""), wxDefaultPosition,
                                 wxDLG_UNIT(m_panel126, wxSize(-1, -1)), wxTE_PROCESS_ENTER);
#ifdef __WXMSW__
    ...
    boxSizer116->Add(m_textCtrl1, 0, wxALL | wxEXPAND, WXC_FROM_DIP(2));
...
{
    this->Disconnect(wxID_CLEAR, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler(SSHTerminalBase::OnClear), NULL,
                     this);
    this->Disconnect(wxID_CLEAR, wxEVT_UPDATE_UI, wxUpdateUIEventHandler(SSHTerminalBase::OnClearUI), NULL, this);
    m_textCtrl1->Disconnect(wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(SSHTerminalBase::OnSendCommand), NULL,
                            this);
}
