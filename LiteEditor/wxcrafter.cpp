    ...
    : wxControl(parent, id, pos, size, style)
{
    ...
    m_mainPanel = new clThemedSplitterWindow(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxSP_3D);
    m_mainPanel->SetSashGravity(0.5);
    m_mainPanel->SetMinimumPaneSize(10);
    
    boxSizer149->Add(m_mainPanel, 1, wxEXPAND, WXC_FROM_DIP(5));
    
    m_buttonsPage = new wxPanel(m_mainPanel, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_mainPanel, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_listPage = new wxPanel(m_mainPanel, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_mainPanel, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_panelList = new wxPanel(m_listPage, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_listPage, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_staticText0 = new wxStaticText(m_panelList, wxID_ANY, _("Recently opened workspaces"), wxDefaultPosition, wxDLG_UNIT(m_panelList, wxSize(-1,-1)), 0);
    
    boxSizer668->Add(m_staticText0, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, WXC_FROM_DIP(5));
    
    m_dvTreeCtrlWorkspaces = new clThemedTreeCtrl(m_panelList, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelList, wxSize(-1,200)), wxTR_DEFAULT_STYLE|get_border_simple_theme_aware_bit());
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_panel625 = new wxPanel(m_panelCxx, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelCxx, wxSize(-1,-1)), wxTAB_TRAVERSAL|wxBORDER_NONE);
    ...
    m_toolbar580 = new clToolBar(m_panel625, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel625, wxSize(-1,-1)), wxTB_NODIVIDER|wxTB_FLAT);
    m_toolbar580->SetToolBitmapSize(wxSize(16,16));
    
    boxSizer627->Add(m_toolbar580, 0, wxEXPAND, WXC_FROM_DIP(2));
    
    m_configChangeCtrl = new clConfigurationSelectionCtrl(m_panel625, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel625, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    
    boxSizer627->Add(m_configChangeCtrl, 0, wxEXPAND, WXC_FROM_DIP(2));
    
    m_splitter = new clThemedSplitterWindow(m_panelCxx, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelCxx, wxSize(-1,-1)), wxSP_LIVE_UPDATE);
    m_splitter->SetSashGravity(0);
    m_splitter->SetMinimumPaneSize(10);
    ...
    m_dvListCtrlPinnedProjects = new clThemedListCtrl(m_splitterPagePinnedProjects, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPagePinnedProjects, wxSize(-1,150)), wxDV_NO_HEADER|wxDV_ROW_LINES|wxDV_SINGLE|wxBORDER_NONE|get_border_simple_theme_aware_bit());
    ...
    m_fileView = new FileViewTree(m_splitterPageTreeView, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPageTreeView, wxSize(-1,-1)), wxTR_MULTIPLE|wxTR_NO_LINES|wxTR_HAS_BUTTONS);
    ...
    // Connect events
    m_dvListCtrlPinnedProjects->Bind(wxEVT_COMMAND_DATAVIEW_ITEM_CONTEXT_MENU, &WorkspaceTabBase::OnPinnedCxxProjectContextMenu, this);
    m_dvListCtrlPinnedProjects->Bind(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED, &WorkspaceTabBase::OnPinnedCxxProjectSelected, this);
    
}

WorkspaceTabBase::~WorkspaceTabBase()
{
    m_dvListCtrlPinnedProjects->Unbind(wxEVT_COMMAND_DATAVIEW_ITEM_CONTEXT_MENU, &WorkspaceTabBase::OnPinnedCxxProjectContextMenu, this);
    m_dvListCtrlPinnedProjects->Unbind(wxEVT_COMMAND_DATAVIEW_SELECTION_CHANGED, &WorkspaceTabBase::OnPinnedCxxProjectSelected, this);
