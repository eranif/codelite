...
static const wxCmdLineEntryDesc s_cmdDesc[] = {
    { wxCMD_LINE_SWITCH, "v", "version", "Print version and exit", wxCMD_LINE_VAL_NONE,
      wxCMD_LINE_PARAM_OPTIONAL },
    { wxCMD_LINE_SWITCH, "h", "help", "Print usage and exit", wxCMD_LINE_VAL_NONE,
      wxCMD_LINE_PARAM_OPTIONAL },
    { wxCMD_LINE_OPTION, "o", "output", "Override output directory", wxCMD_LINE_VAL_STRING,
      wxCMD_LINE_PARAM_OPTIONAL },
    { wxCMD_LINE_PARAM, nullptr, nullptr, "Input .wxcp file", wxCMD_LINE_VAL_STRING,
...
static bool GenerateFromProject(const wxString& filename, const wxString& fileContent,
                                const wxString& outputDirOverride)
{
    ...
    for (auto& w : wrappers) {
        ...
        tlw->GenerateCode(wxcProjectMetadata::Get(),
                          /*promptUser=*/false,
                          /*baseOnly=*/false,
                          baseCpp, baseHeader, headers, additionalFiles);
    }
    ...
    autoGenComment << "//////////////////////////////////////////////////////////////////////\n"
                   ...
                   << "// wxCrafter project file: "
                   << wxcProjectMetadata::Get().GetProjectFileName().GetFullName() << "\n"
