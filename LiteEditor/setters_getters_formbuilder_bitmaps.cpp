...
void wxC8861InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/setters_getters_formbuilder_bitmaps.cpp$C__src_codelite_formbuilder_setters_getters_formbuilder_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/setters_getters_formbuilder_bitmaps.cpp$C__src_codelite_formbuilder_setters_getters_formbuilder_bitmaps.xrc"));
}
