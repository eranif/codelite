...
LexerPageBase::LexerPageBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	sbSizer2 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Style Settings:") ), wxHORIZONTAL );
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, _("Edit Keywords:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_button5 = new wxButton( this, wxID_ANY, _("Set &0"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	bSizer5->Add( m_button5, 0, wxALL, 5 );
	
	m_button6 = new wxButton( this, wxID_ANY, _("Set &1"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	bSizer5->Add( m_button6, 0, wxALL, 5 );
	
	m_button7 = new wxButton( this, wxID_ANY, _("Set &2"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	bSizer5->Add( m_button7, 0, wxALL, 5 );
	
	m_button8 = new wxButton( this, wxID_ANY, _("Set &3"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	bSizer5->Add( m_button8, 0, wxALL, 5 );
	
	m_button9 = new wxButton( this, wxID_ANY, _("Set &4"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	bSizer5->Add( m_button9, 0, wxALL, 5 );
	
	fgSizer1->Add( bSizer5, 1, wxEXPAND, 5 );
	
	m_staticText2 = new wxStaticText( this, wxID_ANY, _("Style Font:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText4 = new wxStaticText( this, wxID_ANY, _("Style Background Colour:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_eolFilled = new wxCheckBox( this, wxID_ANY, _("Style is EOL Filled"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_styleWithinPreProcessor = new wxCheckBox( this, wxID_ANY, _("Styling Within Pre-processor Line"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer1 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Lexer Global Settings:") ), wxVERTICAL );
	...
	m_staticText6 = new wxStaticText( this, wxID_ANY, _("Global Font:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText7 = new wxStaticText( this, wxID_ANY, _("Global background Colour:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText8 = new wxStaticText( this, wxID_ANY, _("File Extensions:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer3 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Text Selection:") ), wxVERTICAL );
	...
	m_staticText9 = new wxStaticText( this, wxID_ANY, _("Selected Text Background Colour:"), wxDefaultPosition, wxDefaultSize, 0 );
