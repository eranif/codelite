    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_splitterHorizontal = new wxSplitterWindow(
    ...
    m_splitterPageTop = new wxPanel(m_splitterHorizontal,
                                    wxID_ANY,
                                    wxDefaultPosition,
                                    wxDLG_UNIT(m_splitterHorizontal, wxSize(-1, -1)),
                                    wxTAB_TRAVERSAL);

    wxBoxSizer* boxSizer289 = new wxBoxSizer(wxVERTICAL);
    m_splitterPageTop->SetSizer(boxSizer289);

    m_splitterVertical = new clThemedSplitterWindow(m_splitterPageTop,
                                                    wxID_ANY,
                                                    wxDefaultPosition,
    ...
    m_splitterPageBacktrace = new wxPanel(m_splitterVertical,
                                          wxID_ANY,
                                          wxDefaultPosition,
                                          wxDLG_UNIT(m_splitterVertical, wxSize(-1, -1)),
                                          wxTAB_TRAVERSAL);

    wxBoxSizer* boxSizer243 = new wxBoxSizer(wxHORIZONTAL);
    m_splitterPageBacktrace->SetSizer(boxSizer243);

    m_splitterThreadsFrames = new wxSplitterWindow(m_splitterPageBacktrace,
                                                   wxID_ANY,
                                                   wxDefaultPosition,
                                                   wxDLG_UNIT(m_splitterPageBacktrace, wxSize(-1, -1)),
                                                   wxSP_LIVE_UPDATE | wxSP_3DSASH);
    ...
    m_splitterPageThreads = new wxPanel(m_splitterThreadsFrames,
                                        wxID_ANY,
                                        wxDefaultPosition,
                                        wxDLG_UNIT(m_splitterThreadsFrames, wxSize(-1, -1)),
                                        wxTAB_TRAVERSAL);

    wxBoxSizer* boxSizer298 = new wxBoxSizer(wxVERTICAL);
    m_splitterPageThreads->SetSizer(boxSizer298);

    m_dvListCtrlThreadId = new clThemedListCtrl(m_splitterPageThreads,
                                                wxID_ANY,
                                                wxDefaultPosition,
                                                wxDLG_UNIT(m_splitterPageThreads, wxSize(150, -1)),
                                                wxDV_ROW_LINES | wxDV_SINGLE);

    boxSizer298->Add(m_dvListCtrlThreadId, 1, wxEXPAND, WXC_FROM_DIP(5));

    m_dvListCtrlThreadId->AppendTextColumn(
        _("ID"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(50), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_dvListCtrlThreadId->AppendTextColumn(
        _("Active"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(24), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_dvListCtrlThreadId->AppendTextColumn(
        _("Name"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_splitterPageFrames = new wxPanel(m_splitterThreadsFrames,
                                       wxID_ANY,
                                       wxDefaultPosition,
                                       wxDLG_UNIT(m_splitterThreadsFrames, wxSize(-1, -1)),
                                       wxTAB_TRAVERSAL);
    ...
    m_dvListCtrlFrames = new clThemedListCtrl(m_splitterPageFrames,
                                              wxID_ANY,
                                              wxDefaultPosition,
                                              wxDLG_UNIT(m_splitterPageFrames, wxSize(-1, -1)),
                                              wxDV_ROW_LINES | wxDV_SINGLE);

    boxSizer299->Add(m_dvListCtrlFrames, 1, wxEXPAND, WXC_FROM_DIP(5));

    m_dvListCtrlFrames->AppendTextColumn(
        _("ID"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(50), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_dvListCtrlFrames->AppendTextColumn(
        _("Name"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(100), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_dvListCtrlFrames->AppendTextColumn(
        _("Line"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(100), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_dvListCtrlFrames->AppendTextColumn(
        _("Source"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_splitterPageLocals = new wxPanel(m_splitterVertical,
                                       wxID_ANY,
                                       wxDefaultPosition,
                                       wxDLG_UNIT(m_splitterVertical, wxSize(-1, -1)),
                                       wxTAB_TRAVERSAL);
    ...
    m_variablesTree = new clThemedTreeCtrl(m_splitterPageLocals,
                                           wxID_ANY,
                                           wxDefaultPosition,
    ...
    m_splitterPageBottom = new wxPanel(m_splitterHorizontal,
                                       wxID_ANY,
                                       wxDefaultPosition,
                                       wxDLG_UNIT(m_splitterHorizontal, wxSize(-1, -1)),
                                       wxTAB_TRAVERSAL);
    ...
    : wxDialog(parent, id, title, pos, size, style)
{
    ...
    m_toolbar =
        new wxAuiToolBar(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxAUI_TB_DEFAULT_STYLE);
    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    // Connect events
    m_dvListCtrl->Bind(
        wxEVT_COMMAND_DATAVIEW_ITEM_CONTEXT_MENU, &DAPBreakpointsViewBase::OnBreakpointsContextMenu, this);
}
