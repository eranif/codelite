...
public:
    ...
    inline llm::EventReason GetReason() const { return m_reason; }
    inline void SetReason(llm::EventReason reason) { m_reason = reason; }
    ...
    inline void SetLogLevel(const llm::LogLevel& logLevel) { m_logLevel = logLevel; }
    inline const llm::LogLevel& GetLogLevel() const { return m_logLevel; }
...
private:
    llm::EventReason m_reason{llm::EventReason::kDone};
    std::string m_message;
    wxArrayString m_models;
    llm::LogLevel m_logLevel{llm::LogLevel::kInfo};
