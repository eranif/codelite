...
void wxCF667InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/UI_assistance.ai_bitmaps.cpp$_Users_eifrah_devl_codelite_ChatAI_UI_assistance.ai_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/UI_assistance.ai_bitmaps.cpp$_Users_eifrah_devl_codelite_ChatAI_UI_assistance.ai_bitmaps.xrc"));
}
