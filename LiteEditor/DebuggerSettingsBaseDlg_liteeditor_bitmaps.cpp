...
void wxCrafter6v4fW1InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/DebuggerSettingsBaseDlg_liteeditor_bitmaps.cpp$C__src_codelite_LiteEditor_DebuggerSettingsBaseDlg_liteeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
