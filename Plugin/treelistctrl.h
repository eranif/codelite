...
class WXDLLIMPEXP_SDK wxTreeListColumnInfo: public wxObject {
...
extern WXDLLIMPEXP_SDK const wxChar* wxTreeListCtrlNameStr;

class WXDLLIMPEXP_SDK wxTreeListCtrl : public wxControl
{
