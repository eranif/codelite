    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_notebook10 = new wxNotebook(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), wxBK_DEFAULT|wxBORDER_STATIC);
    ...
    m_checkBoxShowXButton = new wxCheckBox(m_panelTabs, wxID_ANY, _("Show close button on tabs"), wxDefaultPosition, wxDLG_UNIT(m_panelTabs, wxSize(-1,-1)), 0);
    ...
    m_checkBoxShowPath = new wxCheckBox(m_panelTabs, wxID_ANY, _("Show Parent folder on tabs"), wxDefaultPosition, wxDLG_UNIT(m_panelTabs, wxSize(-1,-1)), 0);
    m_checkBoxShowPath->SetValue(true);
    m_checkBoxShowPath->SetToolTip(_("Label each tab with the last element of its path in addition to the filename.\nThis makes it easier to distinguish between tabs of identically-named files\nbelonging to different folders."));
