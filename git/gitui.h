...
public:
    ...
    wxCheckBox* GetCheckBoxTrackTree()
    {
        return m_checkBoxTrackTree;
    }
    wxPanel* GetPanel236()
    {
        return m_panel236;
    ...
    GitSettingsDlgBase(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Git settings..."), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(500,300), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER);
...
public:
    ...
    wxSplitterWindow* GetSplitterInner()
    {
...
public:
    ...
    clThemedListCtrl* GetDvListCtrlUnversioned()
    {
    ...
    wxSplitterWindow* GetSplitter733()
    {
