...
/**
 * @brief The Float32Array typed array represents an array of 32-bit floating point numbers (corresponding to the C float data type) in the platform byte order. If control over byte order is needed, use DataView instead. The contents are initialized to 0. Once established, you can reference elements in the array using the object's methods, or using standard array index syntax (that is, using bracket notation).
 * @link https://developer.mozilla.orghttps://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Float32Array
 */
function Float32Array() {
	...
	/**
	 * @brief The TypedArray.of() method creates a new typed array with a variable number of arguments. This method is nearly the same as Array.of().
...
/**
 * @brief The filter() method creates a new typed array with all elements that pass the test implemented by the provided function. This method has the same algorithm as Array.prototype.filter(). TypedArray is one of the typed array types here.
 * @link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/filter
 * @param callback - Function to test each element of the typed array. Invoked with arguments (element, index, typedarray). Return true to keep the element, false otherwise.
 * @param thisArg Optional - Value to use as this when executing callback.
 */
TypedArray.prototype.filter = function(callback, thisArg Optional) {};
...
/**
 * @brief The forEach() method executes a provided function once per array element. This method has the same algorithm as Array.prototype.forEach(). TypedArray is one of the typed array types here.
 * @link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/forEach
 * @param callback - Function that produces an element of the new typed array, taking three arguments:   currentValue  The current element being processed in the typed array.
 * @param index - The index of the current element being processed in the array.
 * @param array - The array forEach() was called upon.
 * @param thisArg - Optional. Value to use as this when executing callback.
 */
TypedArray.prototype.forEach = function(callback, index, array, thisArg) {};
...
/**
 * @brief The map() method creates a new typed array with the results of calling a provided function on every element in this typed array. This method has the same algorithm as Array.prototype.map(). TypedArray is one of the typed array types here.
 * @link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/map
 * @param callback - Function that produces an element of the new typed array, taking three arguments:   currentValue  The current element being processed in the typed array.
 * @param index - The index of the current element being processed in the typed array.
 * @param array - The typed array map was called upon.
 * @param thisArg - Optional. Value to use as this when executing callback.
 */
TypedArray.prototype.map = function(callback, index, array, thisArg) {};
...
/**
 * @brief The slice() method returns a shallow copy of a portion of a typed array into a new typed array object. This method has the same algorithm as Array.prototype.slice(). TypedArray is one of the typed array types here.
 * @link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray/slice
 */
TypedArray.prototype.slice = function() {};
