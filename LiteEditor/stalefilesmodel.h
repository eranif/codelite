...
public:
    ...
    // Setters / Getters
    void SetChildren(const wxVector<StaleFilesModel_Item*>& children) { this->m_children = children; }
    void SetData(const wxVector<wxVariant>& data) { this->m_data = data; }
    void SetParent(StaleFilesModel_Item* parent) { this->m_parent = parent; }
    const wxVector<StaleFilesModel_Item*>& GetChildren() const { return m_children; }
    wxVector<StaleFilesModel_Item*>& GetChildren() { return m_children; }
    const wxVector<wxVariant>& GetData() const { return m_data; }
    wxVector<wxVariant>& GetData() { return m_data; }
    StaleFilesModel_Item* GetParent() { return m_parent; }
...
public:
    ...
    void SetData(const wxVector<StaleFilesModel_Item*> data) { this->m_data = data; }
    unsigned int GetColCount() const { return m_colCount; }
    const wxVector<StaleFilesModel_Item*>& GetData() const { return m_data; }
    wxVector<StaleFilesModel_Item*>& GetData() { return m_data; }
