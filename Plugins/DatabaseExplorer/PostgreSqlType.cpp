...
PostgreSqlType::PostgreSqlType(const PostgreSqlType& obj)
    : IDbType(obj)
{
...
IDbType::UNIVERSAL_TYPE PostgreSqlType::GetUniversalType() { return (IDbType::UNIVERSAL_TYPE)m_universalType; }
