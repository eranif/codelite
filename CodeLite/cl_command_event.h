...
public:
    ...
    const wxString& GetOldName() const
    {
        return m_oldName;
    }
    const wxSharedPtr<wxClientData>& GetPtr() const
    {
        return m_ptr;
    }
...
public:
    ...
    virtual wxEvent* Clone() const;
    void SetSourceControlName(const wxString& sourceControlName)
    {
        this->m_sourceControlName = sourceControlName;
    }
    const wxString& GetSourceControlName() const
    {
        return m_sourceControlName;
    }
};
...
public:
    ...
    void SetEntry(wxCodeCompletionBoxEntry::Ptr_t entry)
    {
        this->m_entry = entry;
    }
    wxCodeCompletionBoxEntry::Ptr_t GetEntry()
    {
        return m_entry;
    }
    ...
    void SetEntries(const wxCodeCompletionBoxEntry::Vec_t& entries)
    {
        this->m_entries = entries;
    }
    const wxCodeCompletionBoxEntry::Vec_t& GetEntries() const
    {
        return m_entries;
    }
    ...
    const LSP::CompletionItem::eTriggerKind& GetTriggerKind() const
    {
        return m_triggerKind;
    }
    void SetTriggerKind(const LSP::CompletionItem::eTriggerKind& triggerKind)
    {
        this->m_triggerKind = triggerKind;
    }
...
public:
    ...
    void SetWarningCount(size_t warningCount)
    {
        this->m_warningCount = warningCount;
    }
...
public:
    ...
    const wxString& GetAlternateDebuggerPath() const
    {
        return m_alternateDebuggerPath;
    }
    void SetSshAccount(const wxString& sshAccount)
    {
        this->m_sshAccount = sshAccount;
    }
    const wxString& GetSshAccount() const
    {
        return m_sshAccount;
    }
    void SetIsSSHDebugging(bool isSSHDebugging)
    {
        this->m_isSSHDebugging = isSSHDebugging;
    }
    bool IsSSHDebugging() const
    {
        return m_isSSHDebugging;
    }
    void SetFeatures(size_t features)
    {
        m_features = features;
    }
    ...
    void SetMemoryAddress(const wxString& memoryAddress)
    {
        this->m_memoryAddress = memoryAddress;
    }
    void SetMemoryBlockSize(size_t memoryBlockSize)
    {
        this->m_memoryBlockSize = memoryBlockSize;
    }
    void SetMemoryBlockValue(const wxString& memoryBlockValue)
    {
        this->m_memoryBlockValue = memoryBlockValue;
    }
    const wxString& GetMemoryAddress() const
    {
    ...
    const wxString& GetMemoryBlockValue() const
    {
        return m_memoryBlockValue;
    }
    void SetBreakpoints(const clDebuggerBreakpoint::Vec_t& breakpoints)
    {
        this->m_breakpoints = breakpoints;
    }
    const clDebuggerBreakpoint::Vec_t& GetBreakpoints() const
    {
...
public:
    ...
    virtual wxEvent* Clone() const
    {
        return new clGotoEvent(*this);
    }
    const clGotoEntry::Vec_t& GetEntries() const
    {
        return m_entries;
    }
    clGotoEntry::Vec_t& GetEntries()
    {
        return m_entries;
    }
    void SetEntries(const clGotoEntry::Vec_t& entries)
    {
        m_entries = entries;
    }
    void SetEntry(const clGotoEntry& entry)
    {
        this->m_entry = entry;
    }
    const clGotoEntry& GetEntry() const
    {
        return m_entry;
    }
};
...
public:
    ...
    virtual wxEvent* Clone() const
    {
        return new clProcessEvent(*this);
    }
...
public:
    ...
    virtual wxEvent* Clone() const
    {
        return new clContextMenuEvent(*this);
    }
#if wxUSE_GUI
...
public:
    ...
    virtual wxEvent* Clone() const
    {
        return new clExecuteEvent(*this);
    }
    ...
    const wxString& GetTargetName() const
    {
        return m_targetName;
    }
};
...
public:
    ...
    virtual wxEvent* Clone() const
    {
        return new clFindEvent(*this);
    }

    void SetCtrl(wxStyledTextCtrl* ctrl)
    {
        this->m_ctrl = ctrl;
    }
    wxStyledTextCtrl* GetCtrl()
    {
        return m_ctrl;
    }
};
...
public:
    ...
    virtual wxEvent* Clone() const
    {
        return new clFindInFilesEvent(*this);
    }
    ...
    void SetPaths(const wxString& paths)
    {
        this->m_paths = paths;
    }
    const wxString& GetPaths() const
    {
        return m_paths;
    }
    void SetTransientPaths(const wxString& transientPaths)
    {
        this->m_transientPaths = transientPaths;
    }
    const wxString& GetTransientPaths() const
    {
        return m_transientPaths;
    }
    Match::vec_t& GetMatches()
    {
        return m_matches;
    }
    const Match::vec_t& GetMatches() const
    {
        return m_matches;
    }
    void SetMatches(const Match::vec_t& matches)
    {
        m_matches = matches;
    }
};
...
public:
    ...
    virtual wxEvent* Clone() const
    {
        return new clParseEvent(*this);
    }
    void SetCurfileIndex(size_t curfileIndex)
    {
        this->m_curfileIndex = curfileIndex;
    }
    void SetTotalFiles(size_t totalFiles)
    {
        this->m_totalFiles = totalFiles;
    }
    size_t GetCurfileIndex() const
    {
        return m_curfileIndex;
    }
...
public:
    ...
    virtual wxEvent* Clone() const
    {
        return new clEditorConfigEvent(*this);
    }
    void SetEditorConfig(const clEditorConfigSection& editorConfig)
    {
        this->m_editorConfigSection = editorConfig;
    }
    const clEditorConfigSection& GetEditorConfig() const
    {
        return m_editorConfigSection;
    }
};
...
public:
    ...
    {
        this->m_initOptions = initOptions;
    }
    void SetLanguages(const wxArrayString& languages)
    {
        this->m_languages = languages;
    }
    void SetLspCommand(const wxString& lspCommand)
    {
        this->m_lspCommand = lspCommand;
    }
    void SetLspName(const wxString& lspName)
    {
        this->m_lspName = lspName;
    }
    ...
    const wxString& GetInitOptions() const
    {
    ...
    const wxString& GetLspCommand() const
    {
        return m_lspCommand;
    }
    const wxString& GetLspName() const
    {
        return m_lspName;
    }
    ...
    void SetAction(const eAction& action)
    {
