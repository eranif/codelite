...
void wxCrafterSFKMcrInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/quickdebug_formbuilder_bitmaps.cpp$C__src_codelite_formbuilder_quickdebug_formbuilder_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/quickdebug_formbuilder_bitmaps.cpp$C__src_codelite_formbuilder_quickdebug_formbuilder_bitmaps.xrc"));
}
