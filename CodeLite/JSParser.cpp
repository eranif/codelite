...
{
  "$end", "error", "$undefined", "kJS_FUNCTION", "kJS_VAR", "kJS_DOT",
  "kJS_THIS", "kJS_CATCH", "kJS_THROW", "kJS_SWITCH", "kJS_CASE",
  "kJS_FOR", "kJS_STRING", "kJS_IDENTIFIER", "kJS_PROTOTYPE", "kJS_RETURN",
  "kJS_NEW", "kJS_TRUE", "kJS_FALSE", "kJS_NULL", "kJS_DEC_NUMBER",
  "kJS_OCTAL_NUMBER", "kJS_HEX_NUMBER", "kJS_FLOAT_NUMBER",
  "kJS_PLUS_PLUS", "kJS_MINUS_MINUS", "kJS_LS", "kJS_RS", "kJS_LE",
