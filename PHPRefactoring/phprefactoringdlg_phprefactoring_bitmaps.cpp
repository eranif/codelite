...
void wxCrafterGgLOZbInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/phprefactoringdlg_phprefactoring_bitmaps.cpp$_home_ajenbo_code_codelite_PHPRefactoring_phprefactoringdlg_phprefactoring_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/phprefactoringdlg_phprefactoring_bitmaps.cpp$_home_ajenbo_code_codelite_PHPRefactoring_phprefactoringdlg_phprefactoring_bitmaps.xrc"));
}
