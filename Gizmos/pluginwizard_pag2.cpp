...
: wxWizardPageSimple( parent )
{
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, _("Build Information:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText3 = new wxStaticText( this, wxID_ANY, _("Project Path:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText4 = new wxStaticText( this, wxID_ANY, _("Select the root path of CodeLite source files:"), wxDefaultPosition, wxDefaultSize, 0 );
