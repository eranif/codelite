    ...
    : OptionsConfigPage(parent, options)
{
    ...
    AddProperty(_("Highlight current line number"),
                m_options->IsLineNumberHighlightCurrent(),
                UPDATE_BOOL_CB(SetLineNumberHighlightCurrent));
    AddProperty(
        _("Use relative line numbers"), m_options->GetRelativeLineNumbers(), UPDATE_BOOL_CB(SetRelativeLineNumbers));

    AddHeader(_("What to highlight?"));
    AddProperty(_("Indentation lines"),
                m_options->GetShowIndentationGuidelines(),
                UPDATE_BOOL_CB(SetShowIndentationGuidelines));
    AddProperty(
        _("Matching braces"), m_options->GetHighlightMatchedBraces(), UPDATE_BOOL_CB(SetHighlightMatchedBraces));
    ...
    AddProperty(_("Highlight with colour"),
                m_options->IsHighlightCaretLineWithColour(),
    ...
    AddProperty(_("Show right margin indicator"),
                m_options->IsShowRightMarginIndicator(),
    ...
    AddProperty(_("Highlight debugger line"),
                m_options->HasOption(OptionsConfig::Opt_Mark_Debugger_Line),
    ...
    AddHeader(_("Whitespace"));
    {
        ...
        AddProperty(_("Indentation visibility"),
                    options,
                    m_options->GetShowWhitespaces(),
