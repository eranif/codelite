    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_auibar->AddTool(XRCID("git_settings"), _("git settings"), wxXmlResource::Get()->LoadBitmap(wxT("git-settings")), wxNullBitmap, wxITEM_NORMAL, _("git settings"), _("git settings"), NULL);
