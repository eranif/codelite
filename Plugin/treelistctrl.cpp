...
class WXDLLIMPEXP_SDK wxTreeListHeaderWindow : public wxWindow
{
protected:
...
class WXDLLIMPEXP_SDK wxTreeListMainWindow: public wxScrolledWindow
{
public:
    // creation
    // --------
...
public:
    // ctors & dtor
    wxTreeListItem() { m_data = NULL; m_toolTip = NULL; }
