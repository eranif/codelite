    ...
    : CCDisplayAndBehaviorBase( parent )
{
    ...
    m_spinCtrlNumberOfCCItems->SetValue( ::wxIntToString( data.GetCcNumberOfDisplayItems()) );
}
...
void CCDisplayAndBehvior::Save(TagsOptionsData& data)
{
    ...
    data.SetCcNumberOfDisplayItems( ::wxStringToInt(m_spinCtrlNumberOfCCItems->GetValue(), 100, 50));
}
