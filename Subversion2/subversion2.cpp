...
void Subversion2::ChangeLog(const wxString& path, const wxString& fullpath, wxCommandEvent& event)
{
    ...
    if(dlg.ShowModal() == wxID_OK) {
        ...
        GetConsole()->Execute(command, path,
...
void Subversion2::DoLockFile(
    const wxString& workingDirectory, const wxArrayString& fullpaths, wxCommandEvent& event, bool lock)
{
    wxString command;
    wxString loginString;
...
void Subversion2::DoRename(
    const wxString& workingDirectory, const wxString& oldname, const wxString& newname, wxCommandEvent& event)
{
    wxString command;
    wxString loginString;
...
std::vector<wxString> Subversion2::RemoveExcludeExts(
    const std::vector<wxString>& aryInFiles, const wxString& excludeExtensions)
{
...
void Subversion2::OnSync(wxCommandEvent& event)
{
    ...
    GetConsole()->Execute(command, workDir,
