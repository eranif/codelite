...
void wxC69AFInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/UI_wordcompletion_bitmaps.cpp$C__src_codelite_WordCompletion_UI_wordcompletion_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
