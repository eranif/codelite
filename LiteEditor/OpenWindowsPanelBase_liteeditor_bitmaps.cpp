...
void wxCrafterKq0OgDInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/OpenWindowsPanelBase_liteeditor_bitmaps.cpp$C__src_codelite_LiteEditor_OpenWindowsPanelBase_liteeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
