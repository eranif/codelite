...
class ImportFilesBaseDlg : public wxDialog 
{
	...
	public:
		ImportFilesBaseDlg( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Import Files From Directory"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 442,229 ), long style = wxDEFAULT_DIALOG_STYLE );
