    ...
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_staticText109 = new wxStaticText(
        m_panelGeneral, wxID_ANY, _("Program:"), wxDefaultPosition, wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)), 0);
    ...
    m_comboBoxExecutable = new clThemedComboBox(m_panelGeneral,
                                                wxID_ANY,
                                                wxT(""),
                                                wxDefaultPosition,
                                                wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)),
                                                m_comboBoxExecutableArr,
                                                0);
#if wxVERSION_NUMBER >= 3000
    ...
    m_staticText191 = new wxStaticText(m_panelGeneral,
                                       wxID_ANY,
                                       _("Working directory:"),
                                       wxDefaultPosition,
                                       wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)),
    ...
    m_textCtrlWD = new clThemedTextCtrl(
    ...
    m_staticText35 = new wxStaticText(m_panelGeneral,
                                      wxID_ANY,
                                      _("File extensions:"),
                                      wxDefaultPosition,
                                      wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)),
    ...
    m_textCtrlFileExt = new clThemedTextCtrl(
        m_panelGeneral, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)), 0);
    ...
    m_staticText187 = new wxStaticText(m_panelGeneral,
                                       wxID_ANY,
                                       _("Exclude files:"),
                                       wxDefaultPosition,
                                       wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)),
    ...
    m_textCtrlExcludeFiles = new clThemedTextCtrl(
        m_panelGeneral, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)), 0);
    ...
    m_staticText207 = new wxStaticText(m_panelGeneral,
                                       wxID_ANY,
                                       _("Exclude paths:"),
                                       wxDefaultPosition,
                                       wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)),
    ...
    m_textCtrlExcludePaths = new clThemedTextCtrl(
        m_panelGeneral, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)), 0);
    ...
    m_button213 = new wxButton(
        m_panelGeneral, wxID_ANY, _("Edit"), wxDefaultPosition, wxDLG_UNIT(m_panelGeneral, wxSize(-1, -1)), 0);
    ...
    m_staticText125 = new wxStaticText(
        m_panelBuild, wxID_ANY, _("Tool chain:"), wxDefaultPosition, wxDLG_UNIT(m_panelBuild, wxSize(-1, -1)), 0);
    ...
    m_choiceCompiler = new clThemedChoice(
        m_panelBuild, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelBuild, wxSize(-1, -1)), m_choiceCompilerArr, 0);
    ...
    m_dvListCtrlTargets = new clThemedListCtrl(m_panelBuild,
                                               wxID_ANY,
                                               wxDefaultPosition,
                                               wxDLG_UNIT(m_panelBuild, wxSize(-1, -1)),
                                               wxDV_ROW_LINES | wxDV_SINGLE);

    boxSizer38->Add(m_dvListCtrlTargets, 1, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_dvListCtrlTargets->AppendTextColumn(
        _("Target Name"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    m_dvListCtrlTargets->AppendTextColumn(
        _("Command"), wxDATAVIEW_CELL_INERT, WXC_FROM_DIP(-2), wxALIGN_LEFT, wxDATAVIEW_COL_RESIZABLE);
    ...
    m_buttonEdit = new wxButton(
        m_panelBuild, wxID_EDIT, _("Edit"), wxDefaultPosition, wxDLG_UNIT(m_panelBuild, wxSize(-1, -1)), 0);

    boxSizer40->Add(m_buttonEdit, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    m_buttonDelete = new wxButton(
        m_panelBuild, wxID_DELETE, _("Delete"), wxDefaultPosition, wxDLG_UNIT(m_panelBuild, wxSize(-1, -1)), 0);
    ...
    m_staticText179 = new wxStaticText(
        Debugger, wxID_ANY, _("Debugger:"), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);
    ...
    m_choiceDebuggers = new clThemedChoice(
        Debugger, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), m_choiceDebuggersArr, 0);

    flexGridSizer271->Add(m_choiceDebuggers, 0, wxALL | wxEXPAND, WXC_FROM_DIP(5));

    flexGridSizer271->Add(0, 0, 1, wxALL, WXC_FROM_DIP(5));

    m_staticText256 = new wxStaticText(
        Debugger, wxID_ANY, _("Debugger path:"), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);
    ...
    m_staticText265 = new wxStaticText(
        Debugger, wxID_ANY, _("Startup commands:"), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);
    ...
    m_checkRemoteEnabled = new wxCheckBox(
        Debugger, wxID_ANY, _("Remote target"), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);
    m_checkRemoteEnabled->SetValue(false);

    flexGridRemoteTargetEnable->Add(m_checkRemoteEnabled, 0, wxALL, WXC_FROM_DIP(5));

    m_checkRemoteExtended = new wxCheckBox(
        Debugger, wxID_ANY, _("Extended protocol"), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);
    ...
    m_staticText275 =
        new wxStaticText(Debugger, wxID_ANY, _("Host"), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);

    flexGridRemoteTargetAddress->Add(m_staticText275, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textRemoteTargetHost =
        new wxTextCtrl(Debugger, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);
#if wxVERSION_NUMBER >= 3000
    m_textRemoteTargetHost->SetHint(wxT(""));
#endif

    flexGridRemoteTargetAddress->Add(
        m_textRemoteTargetHost, 0, wxALL | wxEXPAND | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_staticText278 =
        new wxStaticText(Debugger, wxID_ANY, _("Port"), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);

    flexGridRemoteTargetAddress->Add(m_staticText278, 0, wxALL | wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));

    m_textRemoteTargetPort =
        new wxTextCtrl(Debugger, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);
#if wxVERSION_NUMBER >= 3000
    ...
    m_staticText284 = new wxStaticText(
        Debugger, wxID_ANY, _("Post connect commands"), wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);

    boxSizer263->Add(m_staticText284, 0, wxALL, WXC_FROM_DIP(5));

    m_stcRemoteCommands =
        new clThemedSTC(Debugger, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(Debugger, wxSize(-1, -1)), 0);
    // Configure the fold margin
    ...
    m_staticText26 = new wxStaticText(m_panelCodeCompletion,
                                      wxID_ANY,
                                      _("Place your build flags one-per-line here"),
                                      wxDefaultPosition,
                                      wxDLG_UNIT(m_panelCodeCompletion, wxSize(-1, -1)),
                                      0);
    ...
    m_stcCCFlags = new clThemedSTC(
        m_panelCodeCompletion, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panelCodeCompletion, wxSize(-1, -1)), 0);
    // Configure the fold margin
    ...
    m_staticText119 = new wxStaticText(m_panelEnv,
                                       wxID_ANY,
                                       _("Environment variables:"),
                                       wxDefaultPosition,
                                       wxDLG_UNIT(m_panelEnv, wxSize(-1, -1)),
                                       0);
    ...
    m_checkBoxEnableRemote = new wxCheckBox(m_panelRemote,
                                            wxID_ANY,
                                            _("Enable remote development"),
                                            wxDefaultPosition,
                                            wxDLG_UNIT(m_panelRemote, wxSize(-1, -1)),
                                            0);
    ...
    m_staticText161 = new wxStaticText(
        m_panelRemote, wxID_ANY, _("SSH Account:"), wxDefaultPosition, wxDLG_UNIT(m_panelRemote, wxSize(-1, -1)), 0);
    ...
    m_choiceSSHAccount = new wxChoice(m_panelRemote,
                                      wxID_ANY,
                                      wxDefaultPosition,
                                      wxDLG_UNIT(m_panelRemote, wxSize(-1, -1)),
                                      m_choiceSSHAccountArr,
                                      0);
    ...
    m_staticText165 = new wxStaticText(
        m_panelRemote, wxID_ANY, _("Remote folder:"), wxDefaultPosition, wxDLG_UNIT(m_panelRemote, wxSize(-1, -1)), 0);
    ...
    m_textCtrlRemoteFolder = new wxTextCtrl(
        m_panelRemote, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panelRemote, wxSize(-1, -1)), 0);
#if wxVERSION_NUMBER >= 3000
    ...
    m_button169 = new wxButton(
        m_panelRemote, wxID_ANY, _("Browse"), wxDefaultPosition, wxDLG_UNIT(m_panelRemote, wxSize(-1, -1)), 0);
    ...
    m_checkBoxRemoteBuild = new wxCheckBox(m_panelRemote,
                                           wxID_ANY,
                                           _("Use remote build"),
                                           wxDefaultPosition,
                                           wxDLG_UNIT(m_panelRemote, wxSize(-1, -1)),
