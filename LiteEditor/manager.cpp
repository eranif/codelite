...
void Manager::UpdateMenuAccelerators()
{
	...
	LoadAcceleratorTable(GetStarupDirectory() + wxT("/config/accelerators.conf"), menuMap);
...
{
	LoadAcceleratorTable(GetStarupDirectory() + wxT("/config/accelerators.conf"), accelMap);
}
