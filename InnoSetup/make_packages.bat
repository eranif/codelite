...
SET CODELITE_INSTALLER=codelite-2.2.0.%1

:: Installer name for IDE + MinGW
SET CODELITE_INSTALLER_MINGW=codelite-2.2.0.%1-mingw4.4.0

:: Installer name for IDE + MinGW + WX2.8.10
SET CODELITE_INSTALLER_MINGW_WX=codelite-2.2.0.%1-mingw4.4.0-wx2.8.10
