...
/**
@file
Subclass of clProgressDlgBase, which is generated by wxCrafter.
*/

#include "clprogressdlgbase.hpp"
...
class WXDLLIMPEXP_SDK clProgressDlg : public clProgressDlgBase
{
public:
    /** Constructor */
    clProgressDlg(wxWindow* parent, const wxString& title, const wxString& msg, int maxValue);
