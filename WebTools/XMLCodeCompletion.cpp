...
{ 
    ...
    if(ch == '/') {
        ...
        wxCodeCompletionBoxManager::Get().ShowCompletionBox(editor->GetCtrl(), entries, bitmaps, 0, this);
    }
}
...
void XMLCodeCompletion::PrepareHtmlCompletions()
{
    ...
    m_htmlCompletions.push_back(HtmlCompletion("details", "Defines additional details that the user can view or hide"));
    ...
    m_htmlCompletions.push_back(HtmlCompletion("meter", "Defines a scalar measurement within a known range (a gauge)"));
    ...
    m_htmlCompletions.push_back(HtmlCompletion("tt", "Not supported in HTML5. Use CSS instead. Defines teletype text"));
    m_htmlCompletions.push_back(
