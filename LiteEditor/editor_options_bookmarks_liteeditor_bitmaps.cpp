...
void wxCrafterZg1KYTInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/editor_options_bookmarks_liteeditor_bitmaps.cpp$editor_options_bookmarks_liteeditor_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/editor_options_bookmarks_liteeditor_bitmaps.cpp$editor_options_bookmarks_liteeditor_bitmaps.xrc"));
}
