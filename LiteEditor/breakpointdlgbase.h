...
protected:
    ...
    virtual void OnApplyPending(wxCommandEvent& event)
    {
        event.Skip();
    }

public:
    BreakpointsListctrl* GetDvListCtrlBreakpoints()
    {
        return m_dvListCtrlBreakpoints;
    }
    ...
    wxButton* GetButtonDeleteAll()
    {
        return m_buttonDeleteAll;
    }
    wxButton* GetButtonApplyPending()
    {
        return m_buttonApplyPending;
    }
...
protected:
    ...
    virtual void OnPageChanging(wxChoicebookEvent& event)
    {
        event.Skip();
    }
    virtual void OnCheckBreakLineno(wxCommandEvent& event)
    {
        event.Skip();
    }
    virtual void OnCheckBreakLinenoUI(wxUpdateUIEvent& event)
    {
        event.Skip();
    }
    virtual void OnCheckBreakFunction(wxCommandEvent& event)
    {
        event.Skip();
    }
    virtual void OnCheckBreakFunctionUI(wxUpdateUIEvent& event)
    {
        event.Skip();
    }
    virtual void OnCheckBreakMemory(wxCommandEvent& event)
    {
        event.Skip();
    }
    virtual void OnCheckBreakMemoryUI(wxUpdateUIEvent& event)
    {
        event.Skip();
    }
...
public:
    ...
    wxStaticText* GetStaticText51()
    {
        return m_staticText51;
    }
    wxCheckBox* GetCheckLineno()
    {
        return m_checkLineno;
    }
    wxTextCtrl* GetTextLineno()
    {
        return m_textLineno;
    }
    wxCheckBox* GetCheckBreakFunction()
    {
        return m_checkBreakFunction;
    }
    wxTextCtrl* GetTextFunctionname()
    {
        return m_textFunctionname;
    }
    wxCheckBox* GetCheckRegex()
    {
        return m_checkRegex;
    }
    wxCheckBox* GetCheckBreakMemory()
    {
        return m_checkBreakMemory;
    }
    wxTextCtrl* GetTextBreakMemory()
    {
        return m_textBreakMemory;
    }
    wxStaticText* GetStaticText6()
    {
        return m_staticText6;
    }
    wxTextCtrl* GetTextFilename()
    {
    ...
    wxStaticLine* GetStaticline5()
    {
        return m_staticline5;
    }
    wxPanel* GetPanel1()
    {
        return m_panel1;
    }
    wxRadioBox* GetRadioWatchtype()
    {
        return m_radioWatchtype;
    }
    wxStaticText* GetStaticText5()
    {
        return m_staticText5;
    }
    wxTextCtrl* GetTextWatchExpression()
    {
        return m_textWatchExpression;
    }
    wxPanel* GetPanel2()
    {
        return m_panel2;
    }
    wxChoicebook* GetChoicebook()
    {
        return m_choicebook;
    }
    ...
    wxTextCtrl* GetTextCond()
    {
        return m_textCond;
    }
    wxStaticText* GetStaticText11()
    {
        return m_staticText11;
    }
    wxTextCtrl* GetTextCommands()
    {
        return m_textCommands;
    }
    wxCheckBox* GetCheckDisable()
    {
        return m_checkDisable;
    }
    wxCheckBox* GetCheckTemp()
    {
        return m_checkTemp;
    }
