...
wxFBItemBaseDlg::wxFBItemBaseDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText2 = new wxStaticText( this, wxID_ANY, wxT("Title:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText4 = new wxStaticText( this, wxID_ANY, wxT("Project tree folder:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_buttonBrowseVD = new wxButton( this, wxID_ANY, wxT("..."), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_buttonGenerate = new wxButton( this, wxID_OK, wxT("Generate"), wxDefaultPosition, wxDefaultSize, 0 );
