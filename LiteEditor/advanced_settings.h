...
public:
	AdvancedDlg( wxWindow* parent, int id = wxID_ANY, wxString title = wxT("Advanced"), wxPoint pos = wxDefaultPosition, wxSize size = wxSize(800, 600), int style = wxDEFAULT_DIALOG_STYLE );
