...
void ContextHtml::OnCallTipClick(wxScintillaEvent& event)
{
}
...
void ContextHtml::OnDbgDwellEnd(wxScintillaEvent& event)
{
}

void ContextHtml::OnDbgDwellStart(wxScintillaEvent& event)
{
}

void ContextHtml::OnDwellEnd(wxScintillaEvent& event)
{
}

void ContextHtml::OnDwellStart(wxScintillaEvent& event)
{
}
...
bool ContextHtml::IsComment(long pos)
{
	...
	return  style == wxSCI_H_COMMENT       || 
			style == wxSCI_H_XCCOMMENT     ||
			style == wxSCI_H_SGML_COMMENT  ||
			style == wxSCI_HJ_COMMENT      ||
			style == wxSCI_HJ_COMMENTLINE  ||
			style == wxSCI_HJ_COMMENTDOC   ||
			style == wxSCI_HJA_COMMENT     ||
			style == wxSCI_HJA_COMMENTLINE ||
			style == wxSCI_HJA_COMMENTDOC  ||
			style == wxSCI_HB_COMMENTLINE  ||
			style == wxSCI_HBA_COMMENTLINE ||
			style == wxSCI_HP_COMMENTLINE  ||
			style == wxSCI_HPA_COMMENTLINE ||
			style == wxSCI_HPHP_COMMENT    ||
			style == wxSCI_HPHP_COMMENTLINE;
}
