...
SET CODELITE_INSTALLER=codelite-4.0.%2

:: Installer name for IDE + MinGW
SET CODELITE_INSTALLER_MINGW=codelite-4.0.%2-mingw4.6.1

:: Installer name for IDE + MinGW + WX2.9.4
SET CODELITE_INSTALLER_MINGW_WX=codelite-4.0.%2-mingw4.6.1-wx2.9.4
